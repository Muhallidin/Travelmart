<%@ Page Title="" Language="C#" MasterPageFile="~/TravelMartMaster2.Master" AutoEventWireup="True"
    CodeBehind="NoTravelRequest2.aspx.cs" Inherits="TRAVELMART.NoTravelRequest2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="NaviPlaceHolder" runat="server">
    ...
    <div id="PG" style="width: auto; height: auto; overflow: auto;">
        ...
        <div id="Av" style="overflow: auto; overflow-x: hidden; width: 100%; overflow-y: hidden;">
            <div align="left">
                <table class="LeftClass" onload="opener.location.reload();">
                    <tr>
                        <td class="style1">
                ...
                <table class="LeftClass" id="uoTableAdvanceSearch" runat="server">
                    ...
                    <tr>
                        ...
                        <td class="contentValue">
                            <asp:Button ID="uoButtonView" runat="server" CssClass="SmallButton" OnClick="uoButtonView_Click"
                                Text="View" />
                            <asp:Button ID="uoClearFilter" runat="server" CssClass="SmallButton" Text="Clear Filter"
                ...
                <table class="LeftClass" style="vertical-align: top">
                    <tr>
                        <td class="LeftClass">
                ...
                <EmptyDataTemplate>
                    <table class="listViewTable" width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <%--<th style="text-align: center; white-space: normal;">
                                    <asp:Label runat="server" ID="Label2" Width="35px" Text='Origin'></asp:Label>
                                </th>--%>
                            <th>
        ...
        <div id="Bv" style="overflow: auto; width: 100%; overflow-x: scroll; overflow-y: auto;"
                ...
                <ItemTemplate>
                    <table class="listViewTable" width="100%">
                        <tr>
                            ...
                            <td class="leftAligned" style="white-space: normal;">
                                <asp:HyperLink ID="uoHyperLinkName" NavigateUrl='<%# "SuperUserView.aspx?ufn=" + Request.QueryString["ufn"] + "&sfId=" + Eval("SfID") + "&recloc=&st=" + Eval("Status") + "&ID=0&trID="+ Eval("TravelRequestID") +"&manualReqID=0" + "&dt=" + Request.QueryString["dt"] + "&e1TR=0"%>'
                                    runat="server" Width="206px"><%# Eval("Name")%></asp:HyperLink>
                            </td>
                            <td class="leftAligned" style="white-space: normal;">
                            ...
                            <td class="leftAligned" style="white-space: normal;">
                                <asp:Label runat="server" ID="uoLblNationality" Width="200px" Text='<%# Eval("NationalityName")%>'></asp:Label>
                            </td>
                            <td class="leftAligned" style="white-space: normal;">
                                <asp:Label runat="server" ID="Label7" Width="76px" Text='<%#String.Format("{0:dd-MMM-yyyy}", Eval("Birthday"))%>'></asp:Label>
                            </td>
                            <%-- <td class="leftAligned" style="white-space: normal;">
                                    <asp:Label runat="server" ID="uoLabelOrigin" Width="35px" Text='<%# Eval("Origin")%>'></asp:Label>
                                </td>--%>
                        </tr>
                    </table>
                </ItemTemplate>
                <EmptyDataTemplate>
                    <table width="100%" class="listViewTable">
                        <%--<tr>
                                <th colspan="12">
                                    <asp:Label runat="server" ID="uoLblScroll" Width="2000px"></asp:Label>
                                </th>
                            </tr>--%>
                        <tr>
            ...
            <asp:ObjectDataSource ID="uoObjectDataSourceTR" runat="server" MaximumRowsParameterName="MaxRow"
                SelectCountMethod="GetNoTravelRequestListCount" SelectMethod="GetNoTravelRequestList"
            ...
            <asp:HiddenField runat="server" ID="uoHiddenFieldNationality" Value="0" EnableViewState="true" />
        </div>
        <%--</asp:Panel>--%>
        <%--</ContentTemplate>
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="uoDropDownListPortPerRegion" 
                EventName="SelectedIndexChanged" />
        </Triggers>
    </asp:UpdatePanel>--%>
    </div>

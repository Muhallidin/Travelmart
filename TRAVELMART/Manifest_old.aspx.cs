...
{
    public partial class Manifest_old : System.Web.UI.Page
    {
        #region "Events"
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["dt"] != null)
                {
                    ...
                    {
                        //GlobalCode.Field2String(Session["DateFrom"]) = DateTime.Parse(Request.QueryString["dt"].ToString().Replace("_", "/")).ToString("MM/dd/yyyy");
                ...
                //uoHiddenFieldDateRange.Value = UserAccountBLL.GetUserDateRange(Session["UserName"].ToString()).ToString();
                //if (GlobalCode.Field2String(Session["DateFrom"]) == "")
                //{
                //    GlobalCode.Field2String(Session["DateFrom"]) = DateTime.Now.ToString("MM/dd/yyyy");
                //}
                //Session["DateTo"] = DateTime.Parse(GlobalCode.Field2String(Session["DateFrom"])).AddDays(double.Parse(uoHiddenFieldDateRange.Value)-1).ToString("MM/dd/yyyy");

                uoHiddenFieldRole.Value = userRole;//MUser.GetUserRole();
                uoHiddenFieldUser.Value = userName;//Session["UserName"].ToString();
                uoHiddenFieldUserId.Value = userName;//Session["UserName"].ToString();

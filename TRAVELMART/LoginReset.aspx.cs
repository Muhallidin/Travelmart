...
namespace TRAVELMART
{
    public partial class LoginReset : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (MUser.GetLDAPLoginIsON() == "1")
                {
                    ...
                    {
                        string sLDAPURL = MUser.GetLDAPUrl();//ConfigurationSettings.AppSettings["LDAP-URL-Main"].ToString();
        ...
        ///// </summary>
        ///// <returns></returns>
        //private void ChangePasswordInLDAP(string sNewPassword)
        //{
        //    try
        //    {
        ...
        //            string sAPI_param = "user=" + GlobalCode.Field2String(MUser.GetUserName());

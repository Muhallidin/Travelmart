<%@ Page Title="" Language="C#" MasterPageFile="~/TravelMartMaster.Master" AutoEventWireup="true" CodeBehind="Manifest_old.aspx.cs" Inherits="TRAVELMART.Manifest_old" %>
...
<table width="100%" class="LeftClass" onload="opener.location.reload();">
    <tr>
        ...
        <td >
            <asp:CheckBox ID="uoCheckBoxShowNoBooking" Text="View No Hotel Booking" 
                runat="server" AutoPostBack="True" 
                oncheckedchanged="uoCheckBoxShowNoBooking_CheckedChanged" />
        </td>        
    </tr>       
</table>
                ...
                onitemcommand="uoListViewManifest_ItemCommand">
                    <LayoutTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" class="listViewTable" width="100%">
                            <tr>
                                ...
                                <th><asp:LinkButton ID="LinkButton1" runat="server" CommandName="SortByE1ID">Travel Req No</asp:LinkButton></th>
                    ...
                    <ItemTemplate>     
                        ...
                        <tr>
                            ...
                            <td class="leftAligned">
                                <asp:HyperLink ID="uoHyperLinkName" NavigateUrl='<%# "SuperUserView.aspx?ufn=" + Request.QueryString["ufn"] + "&sfId=" + Eval("SfID") + "&recloc=" + Eval("RecLoc") + "&st=" + Eval("Status") + "&ID=" + Eval("IDBigInt") + "&trID=" + Eval("TravelRequestID") + "&manualReqID=" + Eval("RequestID") + "&dt=" + Request.QueryString["dt"]%>' runat="server"><%# Eval("Name")%></asp:HyperLink>
...
--%>                            
                    ...
                    <EmptyDataTemplate>
                        <table class="listViewTable">
                            ...
                            <tr>
                                <td colspan="15" class="leftAligned">No Record</td>                                
                            </tr>
                        </table>
                    </EmptyDataTemplate>
                </asp:ListView>                    
      ...
      <tr>
        <td class="LeftClass">
            ...
            <asp:ObjectDataSource ID="uoObjectDataSourceManifest" runat="server"                 
                MaximumRowsParameterName="MaxRow" SelectCountMethod="LoadManifestListCount" 
                SelectMethod="LoadManifestList" StartRowIndexParameterName="StartRow" 
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="uoCheckBoxShowNoBooking" 

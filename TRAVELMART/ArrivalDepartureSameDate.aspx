<%@ Page Title="" Language="C#" MasterPageFile="~/TravelMartMaster2.Master" AutoEventWireup="true"
    CodeBehind="ArrivalDepartureSameDate.aspx.cs" Inherits="TRAVELMART.ArrivalDepartureSameDate" %>
...
<asp:Content ContentPlaceHolderID="HeaderContent" ID="ContentHeader" runat="server">
    <div class="PageTitle">
        <table width="100%">
            <tr>
                <td align="left">
                    Same Day Arrival/Departure List
                </td>
                <td align="right">
                    Region: &nbsp;&nbsp
            ...
            <ContentTemplate>
                        ...
                        <EmptyDataTemplate>
                            <table class="listViewTable" width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <th style="text-align: center; white-space: normal;">
                                        <asp:LinkButton Width="120px" ID="uoLinkButtonHeaderBooking" runat="server" CommandName="SortByRemarks">Booking Remarks</asp:LinkButton>
                                    </th>
                                    <th>
                ...
                <div id="Bv" style="overflow: auto; width: 100%; overflow-x: scroll; overflow-y: auto;"
                    ...
                    <asp:ListView runat="server" ID="uoListViewTR" DataSourceID="uoObjectDataSourceTR">
                        ...
                        <ItemTemplate>
                            ...
                            <tr>
                                ...
                                <td class="leftAligned" style="white-space: normal;">
                                    <asp:Label runat="server" ID="uoLblNationality" Width="206px" Text='<%# Eval("NationalityName")%>'></asp:Label>
                                </td>
                                <%--<td class="leftAligned"  style="white-space: normal;">
                                ...
                                <td class="leftAligned" style="white-space: normal;">
                                    <asp:Label runat="server" ID="Label4" Width="100px" Text='<%# String.Format("{0:dd-MMM-yyyy}", Eval("PasportDateIssued"))%>'></asp:Label>
                                </td>
                                <td class="leftAligned" style="white-space: normal;">
                                    <asp:Label runat="server" ID="Label7" Width="100px" Text='<%# String.Format("{0:dd-MMM-yyyy}", Eval("PassportExpiration"))%>'></asp:Label>
                                </td>
                                <td class="leftAligned" style="white-space: normal;">
                    ...
                    <asp:ObjectDataSource ID="uoObjectDataSourceTR" runat="server" MaximumRowsParameterName="MaxRow"
                        SelectCountMethod="GetTravelRequestArrivalDepartureSameDateCount" SelectMethod="GetTravelRequestArrivalDepartureSameDateList"

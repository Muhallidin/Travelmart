<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/TravelMartMaintenanceMaster.Master"
    AutoEventWireup="true" CodeBehind="SafeguardContractAdd.aspx.cs" Inherits="TRAVELMART.SafeguardContractAdd" %>
    ...
    <div class="leftAligned">
                        ...
                        <ItemTemplate>
                            <tr>
                                <td class="leftAligned">
                                    ...
                                    <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox><asp:CheckBox ID="CheckBox1"
                                        runat="server" />
                                </td>
                                <td class="leftAligned">
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td class="contentValueOrig">
                    <asp:DropDownList ID="uoDropDownListRouteFrom" runat="server" Width="250px" AutoPostBack="true"
            ...
            <tr>
                ...
                <td class="contentValueOrig">
                    <asp:DropDownList ID="uoDropDownListRouteTo" runat="server" Width="250px" AutoPostBack="true"
            ...
            <tr>
                ...
                <td colspan="2" style="text-align: left">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="uoDropDownListOrigin"
            ...
            <tr>
                ...
                <td colspan="2" style="text-align: left">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="uoDropDownListDestination"
    ...
    <%-- <div class="PageTitle">
        ...
        <asp:Panel ID="uopanelluggagevan" runat="server" CssClass="CollapsiblePanel">
            <table width="100%">
                        ...
                        <table style="width: 100%" class="LeftAligned" >
                            <tr>
                                ...
                                <td align=left>
                                    ...
                                    <ContentTemplate>
                                            <asp:DropDownList ID="uoDropDownListLuggageVan" runat="server" Width="250px" AutoPostBack=true 
                                            onselectedindexchanged="uoDropDownListLuggageVan_SelectedIndexChanged" >
                                            </asp:DropDownList>                                            
                                    </ContentTemplate>
                                        <Triggers>
                                ...
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator25" runat="server" 
                                            ControlToValidate="uoDropDownListLuggageVan" ErrorMessage="Vehicle type required." 
                                            InitialValue="0" ValidationGroup="LuggageVan">*</asp:RequiredFieldValidator>
                                </td>                                      
                            </tr>
                            <tr>
                                <td align=left>
                                ...
                                <td align=left>
                                    <asp:UpdatePanel ID="UpdatePanel7" runat="server">   
                                        <ContentTemplate>
                                    <asp:TextBox ID="uoTextBoxBags" runat="server" Width="50px" ></asp:TextBox>
                                            <cc1:MaskedEditExtender ID="uoTextBoxBags_MaskedEditExtender" runat="server" 
                                                CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" 
                                                CultureDateFormat="" CultureDatePlaceholder="" CultureDecimalPlaceholder="" 
                                                CultureThousandsPlaceholder="" CultureTimePlaceholder="" Enabled="True" 
                                                Mask="99" MaskType="Number" TargetControlID="uoTextBoxBags" 
                                                InputDirection="RightToLeft">
                                            </cc1:MaskedEditExtender>                                        
                                        </ContentTemplate>
                                            <Triggers>
                                            <asp:AsyncPostBackTrigger ControlID="uoDropDownListVehicleType" 
                                                EventName="SelectedIndexChanged" />                                            
                                        </Triggers>
                                    </asp:UpdatePanel>
                                </td>
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="uoTextBoxBags"
                                        ErrorMessage="Bags required." ValidationGroup="LuggageVan">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>                            
                            <tr id="Tr1">
                                <td align=left>
                                ...
                                <td align=left>
                                    <asp:DropDownList ID="uoDropDownListLVOrigin" runat="server" Width="300px" 
                                    AppendDataBoundItems="True" >
                                ...
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="uoDropDownListLVOrigin"
                                    ErrorMessage="Origin is Required." ValidationGroup="LuggageVan" InitialValue="0">*</asp:RequiredFieldValidator>
                                </td>                              
                            </tr>
                            <tr id="Tr2">
                                <td align=left>
                                ...
                                <td align=left>
                                    <asp:DropDownList ID="uoDropDownListLVDestination" runat="server" Width="300px" 
                                    AppendDataBoundItems="True" >
                                ...
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="uoDropDownListLVDestination"
                                    ErrorMessage="Destination is Required." ValidationGroup="LuggageVan" InitialValue="0">*</asp:RequiredFieldValidator>
                                </td>                                
                            </tr>
                            <tr>
                                <td align=left>
                                    Currency :</td>
                                <td align=left>
                                    <asp:DropDownList ID="uoDropDownListLVCurrency" runat="server" 
                                        ValidationGroup="LuggageVan" Width="180px">
                                    </asp:DropDownList>                                        
                                </td>
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" 
                                        ControlToValidate="uoDropDownListLVCurrency" ErrorMessage="Currency required." 
                                        InitialValue="0" ValidationGroup="LuggageVan">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align=left>
                                    <asp:TextBox ID="uoTextBoxLVRate" runat="server" Width="180px" />
                                    <cc1:MaskedEditExtender ID="MaskedEditExtender1" 
                                        runat="server" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" 
                                        CultureDateFormat="" CultureDatePlaceholder="" CultureDecimalPlaceholder="" 
                                        CultureThousandsPlaceholder="" CultureTimePlaceholder="" Enabled="True" 
                                        Mask="999,999,999.99" MaskType="Number" TargetControlID="uoTextBoxLVRate" 
                                        InputDirection="RightToLeft">
                                    </cc1:MaskedEditExtender>                                        
                                </td>
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" 
                                        ControlToValidate="uoTextBoxLVRate" ErrorMessage="Rate required." 
                                        ValidationGroup="LuggageVan">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>                         
                            <tr><td class="style11"></td>
                                <td align=left class="style12">
                                    <asp:Button ID="uoButtonAddLV" runat="server" OnClick="uoButtonAddLV_Click" 
                                        Text="Add" ValidationGroup="LuggageVan" />
                                </td>
                            </tr>
                            <tr>
                                <td align=left>
                ...
                <tr>
                    <td valign="top" align=left>
                        <asp:GridView ID="uoGridViewLuggageVan" runat="server" Width="100%" 
                        AutoGenerateColumns="False" CssClass=listViewTable OnSelectedIndexChanged="uoGridViewLuggageVan_SelectedIndexChanged" >
                            <Columns>
                                <asp:BoundField DataField="LVVehicleID" HeaderText="Vehicle ID" Visible=false/>
                                <asp:BoundField DataField="LVType" HeaderText="Type"/>
                                <asp:BoundField DataField="LVBags" HeaderText="Bags"/>
                                <asp:BoundField DataField="LVOrigin" HeaderText="Origin"/>
                                <asp:BoundField DataField="LVDestination" HeaderText="Destination"/>                                
                                <asp:BoundField DataField="LVCurrencyID" HeaderText="Currency ID" Visible=false/>
                                <asp:BoundField DataField="LVCurrency" HeaderText="Currency"/>
                                <asp:BoundField DataField="LVRate" HeaderText="Rate" DataFormatString="{0:#,##0.00}"/>                               
                                <asp:ButtonField CommandName="Select" Text="Delete"/>
                            </Columns>
                        </asp:GridView>
                    </td>
        ...
        <cc1:collapsiblepanelextender ID="uoCollapsiblepanelextenderLV" runat="server" TargetControlID="uopanelluggagevan"
    ...
    <%--<div class="PageTitle">
        ...
        <asp:Panel ID="uopanelservicerate" runat="server" CssClass="CollapsiblePanel">
            <table width="100%">
                ...
                <tr>
                    <td>
                        <table style="width: 100%" class="LeftAligned" >                            
                            <tr>
                                <td align=left colspan=4>
                                    <asp:Label ID="Label3" runat="server" Text="Seaman's Visa." ToolTip="(Compulsory ) - each crewmember."></asp:Label>                                     
                                </td>                                
                            </tr>   
                            <tr>
                                <td align=right>
                                    Currency :</td>
                                <td align=left>
                                    <asp:DropDownList ID="uoDropDownListSeamansVisa" runat="server" 
                                        ValidationGroup="ServiceRate" Width="180px">
                                    </asp:DropDownList>                                        
                                </td>                  
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator20" runat="server" 
                                        ControlToValidate="uoDropDownListSeamansVisa" ErrorMessage="Currency required." 
                                        InitialValue="0" ValidationGroup="ServiceRate">*</asp:RequiredFieldValidator>
                                </td>              
                            </tr>   
                            <tr>
                                <td align=right>
                                ...
                                <td align=left>
                                    <asp:TextBox ID="uoTextBoxSeamansVisa" runat="server" Width="180px" />
                                    <cc1:MaskedEditExtender ID="MaskedEditExtender3" 
                                        runat="server" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" 
                                        CultureDateFormat="" CultureDatePlaceholder="" CultureDecimalPlaceholder="" 
                                        CultureThousandsPlaceholder="" CultureTimePlaceholder="" Enabled="True" 
                                        Mask="999,999,999.99" MaskType="Number" TargetControlID="uoTextBoxSeamansVisa" 
                                        InputDirection="RightToLeft">
                                    </cc1:MaskedEditExtender>                                        
                                </td>
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator21" runat="server" 
                                        ControlToValidate="uoTextBoxSeamansVisa" ErrorMessage="Rate required." 
                                        ValidationGroup="ServiceRate">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                            ...
                            <tr>
                                <td align=left colspan=4>
                                    <asp:Label ID="Label4" runat="server" Text="Airline lost baggage tracing."></asp:Label>                                    
                                </td>                                
                            </tr> 
                            <tr>
                                <td align=right>
                                    Currency :</td>
                                <td align=left>
                                    <asp:DropDownList ID="uoDropDownListBaggageTrace" runat="server" 
                                        ValidationGroup="ServiceRate" Width="180px">
                                    </asp:DropDownList>                                        
                                </td>                  
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server" 
                                        ControlToValidate="uoDropDownListBaggageTrace" ErrorMessage="Currency required." 
                                        InitialValue="0" ValidationGroup="ServiceRate">*</asp:RequiredFieldValidator>
                                </td>              
                            </tr> 
                            <tr>
                                ...
                                <td align=left>
                                    <asp:TextBox ID="uoTextBoxBaggageTrace" runat="server" Width="180px" />
                                    <cc1:MaskedEditExtender ID="MaskedEditExtender2" 
                                        runat="server" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" 
                                        CultureDateFormat="" CultureDatePlaceholder="" CultureDecimalPlaceholder="" 
                                        CultureThousandsPlaceholder="" CultureTimePlaceholder="" Enabled="True" 
                                        Mask="999,999,999.99" MaskType="Number" TargetControlID="uoTextBoxBaggageTrace" 
                                        InputDirection="RightToLeft">
                                    </cc1:MaskedEditExtender>                                        
                                </td>
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                        ControlToValidate="uoTextBoxBaggageTrace" ErrorMessage="Rate required." 
                                        ValidationGroup="ServiceRate">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td align=left colspan=4>
                                    <asp:Label ID="Label5" runat="server" Text="Agency fees." ToolTip="Applicable to each individual signing on or off the ship. Covers preparation and submission of visa and immigration sign on/sign off forms; Transportation to immigration and Ministry of Labour office to pay and issue stamp on visa form; Legal representation and assisting crew with customs and immigration formalities at the Port."></asp:Label>                                     
                                </td>                                
                            </tr>  
                            <tr>
                                <td align=right>
                                    Currency :</td>
                                <td align=left>
                                    <asp:DropDownList ID="uoDropDownListAgencyFees" runat="server" 
                                        ValidationGroup="ServiceRate" Width="180px">
                                    </asp:DropDownList>                                        
                                </td>                  
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator23" runat="server" 
                                        ControlToValidate="uoDropDownListAgencyFees" ErrorMessage="Currency required." 
                                        InitialValue="0" ValidationGroup="ServiceRate">*</asp:RequiredFieldValidator>
                                </td>              
                            </tr>
                            <tr>
                                ...
                                <td align=left>
                                    <asp:TextBox ID="uoTextBoxAgencyFees" runat="server" Width="180px" />
                                    <cc1:MaskedEditExtender ID="MaskedEditExtender4" 
                                        runat="server" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" 
                                        CultureDateFormat="" CultureDatePlaceholder="" CultureDecimalPlaceholder="" 
                                        CultureThousandsPlaceholder="" CultureTimePlaceholder="" Enabled="True" 
                                        Mask="999,999,999.99" MaskType="Number" TargetControlID="uoTextBoxAgencyFees" 
                                        InputDirection="RightToLeft">
                                    </cc1:MaskedEditExtender>                                        
                                </td>
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" 
                                        ControlToValidate="uoTextBoxAgencyFees" ErrorMessage="Rate required." 
                                        ValidationGroup="ServiceRate">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td align=left colspan=4>
                                    <asp:Label ID="Label6" runat="server" Text="Airline okay to board ea sign on crew." ToolTip="Service provided by Travel Agency."></asp:Label>                                    
                                </td>                                
                            </tr>      
                            <tr>
                                <td align=right>
                                    Currency :</td>
                                <td align=left>
                                    <asp:DropDownList ID="uoDropDownListOkToBoard" runat="server" 
                                        ValidationGroup="ServiceRate" Width="180px">
                                    </asp:DropDownList>                                        
                                </td>  
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator24" runat="server" 
                                        ControlToValidate="uoDropDownListOkToBoard" ErrorMessage="Currency required." 
                                        InitialValue="0" ValidationGroup="ServiceRate">*</asp:RequiredFieldValidator>
                                </td>                              
                            </tr>
                            <tr>
                                ...
                                <td align=left>
                                    <asp:TextBox ID="uoTextBoxOkToBoard" runat="server" Width="180px" />
                                    <cc1:MaskedEditExtender ID="MaskedEditExtender5" 
                                        runat="server" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" 
                                        CultureDateFormat="" CultureDatePlaceholder="" CultureDecimalPlaceholder="" 
                                        CultureThousandsPlaceholder="" CultureTimePlaceholder="" Enabled="True" 
                                        Mask="999,999,999.99" MaskType="Number" TargetControlID="uoTextBoxOkToBoard" 
                                        InputDirection="RightToLeft">
                                    </cc1:MaskedEditExtender>                                        
                                </td>
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" 
                                        ControlToValidate="uoTextBoxOkToBoard" ErrorMessage="Rate required." 
                                        ValidationGroup="ServiceRate">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>           
                            <tr><td class="style11"></td>
                                <td align=left class="style12">
                                    <asp:Button ID="uoButtonAddSR" runat="server" OnClick="uoButtonAddSR_Click" 
                                        Text="Add" ValidationGroup="ServiceRate" />
                                </td>
                            </tr>
                            <tr>
                                <td align=left>
                ...
                <tr>
                    <td valign="top" align=left>
                        <asp:GridView ID="uoGridViewServiceRate" runat="server" Width="100%" 
                        AutoGenerateColumns="False" CssClass=listViewTable OnSelectedIndexChanged="uoGridViewServiceRate_SelectedIndexChanged" >
                            <Columns>                                
                                <asp:BoundField DataField="SRSeamansVisaCurrencyID" HeaderText="Seaman’s Visa (Currency ID)" Visible=false/>
                                <asp:BoundField DataField="SRSeamansVisaCurrency" HeaderText="Seaman’s Visa (Currency)"/>
                                <asp:BoundField DataField="SRSeamansVisaRate" HeaderText="Seaman’s Visa (Rate)" DataFormatString="{0:#,##0.00}"/> 
                                <asp:BoundField DataField="SRBaggageTraceCurrencyID" HeaderText="Airline lost baggage tracing (Currency ID)" Visible=false/>
                                <asp:BoundField DataField="SRBaggageTraceCurrency" HeaderText="Airline lost baggage tracing (Currency)"/>
                                <asp:BoundField DataField="SRBaggageTraceRate" HeaderText="Airline lost baggage tracing (Rate)" DataFormatString="{0:#,##0.00}"/> 
                                <asp:BoundField DataField="SRAgencyFeesCurrencyID" HeaderText="Agency fees (Currency ID)" Visible=false/>
                                <asp:BoundField DataField="SRAgencyFeesCurrency" HeaderText="Agency fees (Currency)"/>
                                <asp:BoundField DataField="SRAgencyFeesRate" HeaderText="Agency fees (Rate)" DataFormatString="{0:#,##0.00}"/>                               
                                <asp:BoundField DataField="SROkToBoardCurrencyID" HeaderText="Airline okay to board ea sign on crew (Currency ID)" Visible=false/>
                                <asp:BoundField DataField="SROkToBoardCurrency" HeaderText="Airline okay to board ea sign on crew (Currency)"/>
                                <asp:BoundField DataField="SROkToBoardRate" HeaderText="Airline okay to board ea sign on crew (Rate)" DataFormatString="{0:#,##0.00}"/>
                                <asp:ButtonField CommandName="Select" Text="Delete"/>
                            </Columns>
                        </asp:GridView>
                    </td>
        ...
        <cc1:collapsiblepanelextender ID="uoCollapsiblepanelextenderSR" runat="server" TargetControlID="uopanelservicerate"

<%@ Page Title="" Language="C#" MasterPageFile="~/Popup.Master" AutoEventWireup="true" CodeBehind="CrewAssistPopUp.aspx.cs" Inherits="TRAVELMART.CrewAssistPopUp" %>
...
<cc1:ModalPopupExtender ID="mp1" runat="server" PopupControlID="Panl1" TargetControlID="Button1"
    ...
    <asp:Panel ID="Panl1" runat="server" CssClass="Popup" align="center" style = "display:none">
        <iframe style=" width: 350px; height: 300px;" id="irm1" src="~/CrewAssist/CrewAssistConfirmHotel.aspx" runat="server"></iframe>
       <br/>
    ...
    <table style="width: 100%;">
        ...
        <%--<tr>
            ...
            <td >
               <asp:CheckBox ID="CheckBoxYes" runat="server" Text="Yes" />&nbsp;
                <asp:CheckBox ID="CheckBoxNo" runat="server" Text="No" onlcick="checkboxEnable(this);" OnCheckedChanged="CheckBoxNo_OnCheckedChanged"/>&nbsp;
            </td>
      ...
      <%--  <tr>
       ...
       <tr>
        ...
        <asp:HiddenField ID="uoHiddenFieldCrewAssistRequestID" runat="server" Value=""/>
        <asp:HiddenField ID="uoHiddenFieldDate" runat="server" Value=""/>
        <asp:HiddenField ID="uoHiddenFieldContactNo" runat="server" Value="09201502809"/>
        <asp:HiddenField ID="uoHiddenFieldEmailVendor" runat="server" Value="dinie445@Yahoo.com"/>

<%@ Page Title="" Language="C#" MasterPageFile="~/Popup.Master" AutoEventWireup="true" CodeBehind="VehicleEditor2.aspx.cs" Inherits="TRAVELMART.VehicleEditor2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript" language="javascript">
        ...
        function confimSave() {
            ...
            var IsEdit = $("#<%=uoHiddenFieldIsEdit.ClientID %>").val();

            if (iAdd > 0) {
                var txtPickupDate = $("#<%=uoTextBoxPickupDate.ClientID %>").val();
                var txtPickupTime = $("#<%=uoTextBoxPickupTime.ClientID %>").val();

                if (txtPickupDate == '' || txtPickupDate == 'MM/dd/yyyy') {
                    alert('No Pickup date!');
                    return false;
                }
                if (txtPickupTime == '' || txtPickupTime == 'HH:mm') {
                    alert('No Pickup time!');
                    return false;
                }
                if ($("#<%=uoDropDownListFrom.ClientID %>").val() == '0') {
                    alert('No Route From!');
                    return false;
                }
                if ($("#<%=uoDropDownListTo.ClientID %>").val() == '0') {
                    alert('No Route To!');
                    return false;
                }            
                sMsg = 'There is/are ' + iAdd + ' record(s) to be updated. '
            }  
            ...
            if (IsEdit == '0') {
                ...
                if (iAdd > 0) {
                    sMsg = 'There is/are ' + iAdd + ' record(s) to be added. '
                }
                if (iDelete > 0) {
                    sMsg = sMsg + '\nThere is/are ' + iDelete + ' record(s) to be deleted. '
                }                
            }
    ...
    <div class="ViewTitlePadding">
       <table width="100%" cellpadding="0" cellspacing="0" class="PageTitle">
            <tr>
                <td>
                    <asp:Label ID="uoLabelTitle" runat="server" Text="Edit Transportation" CssClass="Title"></asp:Label>                    
                </td>
            </tr>
        </table>
    </div>
        ...
        <table width="100%">
            ...
            <tr>
                            ...
                            <td>
                              ...
                              <%--
                                   <asp:RequiredFieldValidator runat="server" 
                                       ...
                                       ValidationGroup="Email" InitialValue="0"
                                       ErrorMessage="Route From required." ControlToValidate="uoDropDownListFrom">*
                            ...
                            <td>
                                 <%--
                                     ...
                                     <asp:RequiredFieldValidator 
                                          ...
                                          InitialValue="0"
                                          ErrorMessage="Route To required." 
                                          ControlToValidate="uoDropDownListTo">*
                                     </asp:RequiredFieldValidator>
             ...
             <tr>
                ...
                <td colspan="3">
                    <asp:TextBox runat="server" ID="uoTextBoxComment" Width="500px" TextMode="MultiLine" Rows="2" ></asp:TextBox>
                </td>
    ...
    <div id="Div2" class="PageSubTitle" style="text-decoration: underline;">
        <asp:Label ID="uoLabelSubTitle" runat="server" Text="Edit Transportation"></asp:Label>
    </div>
    ...
    <div runat="server" id = "ucDivToCancel">
       <br />

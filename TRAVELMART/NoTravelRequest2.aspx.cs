...
{
    public partial class NoTravelRequest2 : System.Web.UI.Page
    {
        #region "Events"
        /// <summary>
        ...
        protected void uoObjectDataSourceTR_Selecting(object sender, ObjectDataSourceSelectingEventArgs e)
        {
            ...
            e.InputParameters["RegionID"] = GlobalCode.Field2Int(uoHiddenFieldRegion.Value).ToString();
        ...
        protected void uoBtnSaveToExcel_Click(object sender, EventArgs e)
        {
            ...
            {
                AlertMessage("There are no records to export.");
            }
        }

        protected void uoClearFilter_Click(object sender, EventArgs e)
        {
            ClearFilter();
        }
        ...
        private void GetNoTravelRequestList()
        {
            try
            {
                ...
                //List<TRAVELMART.Common.NoTravelRequest> list = new List<TRAVELMART.Common.NoTravelRequest>();
                //TravelRequestBLL BLL = new TravelRequestBLL();
                //list = BLL.GetNoTravelRequestList(0, GlobalCode.Field2DateTime(uoHiddenFieldDate.Value), GlobalCode.Field2DateTime(uoHiddenFieldDate.Value),
                //    uoHiddenFieldUser.Value, uoHiddenFieldUserRole.Value, uoHiddenFieldOrderBy.Value,0,0, GlobalCode.Field2Int(uoDropDownListVessel.SelectedValue),
                //    GlobalCode.Field2Int(uoDropDownListFilterBy.SelectedValue), uoTextBoxFilter.Text, GlobalCode.Field2Int(uoDropDownListNationality.SelectedValue),
                //    GlobalCode.Field2Int(uoDropDownListGender.SelectedValue), GlobalCode.Field2Int(uoDropDownListRank.SelectedValue), uoDropDownListStatus.SelectedValue,
                //    GlobalCode.Field2Int(uoHiddenFieldRegion.Value), GlobalCode.Field2Int(uoHiddenFieldCountry.Value), GlobalCode.Field2Int(uoHiddenFieldCity.Value),
                //    GlobalCode.Field2Int(uoHiddenFieldPort.Value));

                //uoListViewTR.DataSource = list;
                //uoListViewTR.DataBind();
        ...
        { 
            ...
            return TRBLL.GetNoTravelList(GlobalCode.Field2DateTime(Session["DateFrom"]), GlobalCode.Field2String(Session["UserName"]), RegionID);
        }

        protected void CreateFile(DataTable dt)
        {
            string strFileName ="";
            string FilePath = Server.MapPath("~/Extract/NoTravelRequest/");
            ...
            {
                string FileName = "NoTravelRequest_" + sDate + ".xls";
        ...
        public static void CreateExcel(DataTable dtSource, string strFileName)
        {
            ...
            using (XmlTextWriter xtwWriter = new XmlTextWriter(strFileName, Encoding.UTF8))
            {
                ...
                xtwWriter.WriteAttributeString("ss", "Name", null, "No Hotel Request");
        ...
        public void OpenExcelFile(string strFileName, string filePath)
        {
            ...
            string strScript = "CloseModal('../Extract/NoTravelRequest/" + strFileName + "');";
        ...
        /// Description: clear advance search filters
        /// </summary>
        ...
        private void RefreshParameters()
        {
            ...
            uoObjectDataSourceTR.SelectParameters["RegionID"].DefaultValue = GlobalCode.Field2Int(uoHiddenFieldRegion.Value).ToString();

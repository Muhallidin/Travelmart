<%@ Page Title="" Language="C#" MasterPageFile="~/Popup.Master" AutoEventWireup="true" CodeBehind="HotelRoomEmergencyEdit2.aspx.cs" Inherits="TRAVELMART.HotelRoomEmergencyEdit2" %>
             ...
             $.ajax({
                 ...
                 success: function(data) {
                     ...
                     if (data.d.length > 0) {
                         ...
                         $("#<%=uoLabelEmergencyRoomBlocks.ClientID %>").text(data.d[0].RoomBlocks);
                     ...
                     // no data found
                         ...
                         $("#<%=uoLabelEmergencyRoomBlocks.ClientID %>").text(0);
...
<table class="TableEditor">        
    ...
    <tr>
        <th colspan="3">Emergency Room Block(s)</th>
    </tr>
    <tr>
        <td class="caption">Room Block(s) :</td>
        <td class="value">
            <asp:Label ID="uoLabelEmergencyRoomBlocks" runat="server"></asp:Label>        
        </td>
    </tr>
    <tr>
        <td><br /></td>
    ...
    <tr>
        <th colspan="3">Add Emergency Room Block(s)</th>
    </tr>    
     <tr>
        <td class="caption">Room Block(s):</td>
        <td class="value">

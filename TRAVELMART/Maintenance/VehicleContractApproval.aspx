...
CodeBehind="VehicleContractApproval.aspx.cs" Inherits="TRAVELMART.Maintenance.VehicleContractApproval" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="HeaderContent" runat="server">
    <div class="ViewTitlePadding">
        <table width="100%" cellpadding="0" cellspacing="0" class="PageTitle">
            <tr>
                <td align="Left">
                    Vehicle Contract For Approval List
                </td>
            </tr>
        </table>
    </div>
...
<div id="Bv" style="overflow: auto; width: 100%; overflow-x: auto; overflow-y: auto;">
        ...
        <tr>
        <td class="LeftClass">
            <asp:TextBox runat="server" ID="uoTextBoxVehicle" Text="" Width="300px"></asp:TextBox>&nbsp;
            <asp:Button runat="server" ID="uoButtonSearch" Text="Search" 

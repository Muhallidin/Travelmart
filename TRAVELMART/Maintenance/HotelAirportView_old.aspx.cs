...
{
    public partial class HotelAirportView_old : System.Web.UI.Page
    {
        #region "Events"
        /// -------------------------------------------
        ...
        private void SavePriority()
        {
            foreach (ListViewItem item in uoHotelVendorList.Items)
            {
                ...
                {
                    //Int32 AirportHotelID = MaintenanceViewBLL.SaveHotelPriority(uoDropDownListAirport.SelectedValue, uoHiddenFieldBranchID.Value, uoTextBoxPriority.Text, uoHiddenFieldUser.Value);
                    int AirportHotelID = 0;

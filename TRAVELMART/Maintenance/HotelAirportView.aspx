<%@ Page Title="" Language="C#" MasterPageFile="~/TravelMartMaintenanceMaster.Master"
    AutoEventWireup="true" CodeBehind="HotelAirportView.aspx.cs" Inherits="TRAVELMART.Maintenance.HotelAirportView" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ContentPlaceHolderID="HeaderContent" ID="Content3" runat="server">
    <div class="PageTitle">
        <table style="width: 100%;" cellspacing="0">
            <tr>
                <td class="LeftClass">
                    Airport and Hotel Branch Assignment
                </td>
                <td class="RightClass">
    ...
    <script type="text/javascript">
        ...
        function filterSettings() {
            ...
            ddlRegion.change(function(ev) {
                //                GetCountry($(this).val(), '');
                GetAirport('0', $(this).val(), txtAirport.val());
                ClearAirport();
            });
...
//            });
            ...
            btnAirportFilter.click(function(ev) {
                if (ddlRegion.val() != "0" && ddlCountry.val() != "0") {
                    GetAirport('0', ddlRegion.val(), txtAirport.val());
                }
                return false;
            });
...
//                $("#<%=uoHiddenFieldCountry.ClientID %>").val(ddlCountry.val());
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        for (var i = 0; i < data.d.length; i++) {
                            ...
                            $("<option value='" + data.d[i].AirportIDString + "'>" + data.d[i].AirportCodeString + '-' + data.d[i].AirportNameString + "</option>").appendTo(ddlAirport);
                        }
            ...
            $("#<%=uoBtnHotelAdd.ClientID %>").click(function(ev) {
                ...
                var roomTypeID = $("#<%=uoDropDownListRoomType.ClientID %>").val();
                ...
                if (airportID == "0") {
                    ...
                    $("a#<%=uoHyperLinkAddHotel.ClientID %>").attr("href", "HotelAirportAdd.aspx?aID=" + airportID + "&rID=" + regionID + "&roomID=" + roomTypeID); 
                    //$("a#<%=uoHyperLinkAddHotel.ClientID %>").attr("href", "HotelAirportAdd.aspx?aID=" + airportID + "&rID=" + regionID + "&cID=" + countryID + "&roomID=" + roomTypeID); //+ "&rID=" + regionID  //+ "&aName=" + airportName)
                }
                return true;
            });
                    ...
                    <td style="padding-left: 3px; padding-right: 3px;">
                        <table style="width: 100%" cellspacing="0" class="LeftClass" runat="server" id="uoTableAdvanceSearch">
                            ...
                            <tr>
                                ...
                                <td class="LeftClass">
                                    ...
                                    <asp:Button ID="uoButtonFilterAirport" runat="server" Text="Filter Airport" CssClass="SmallButton"
                                        OnClick="uoButtonFilterAirport_Click" />                                    
                                </td>
                                <td class="RightClass">
                            ...
                            <tr>
                                ...
                                <td class="contentValue">
                                    <asp:DropDownList ID="uoDropDownListRoomType" runat="server" Width="250px" >
                                        <asp:ListItem Text="Double" Value="2" Selected="True"></asp:ListItem>
                ...
                <tr>
                    <td class="Module" align="right">
                        <asp:ListView runat="server" ID="uoHotelVendorList" OnItemCommand="uoHotelVendorList_ItemCommand"
                            OnItemDeleting="uoHotelVendorList_ItemDeleting" OnDataBound="uoHotelVendorList_DataBound"
                            OnItemDataBound="uoHotelVendorList_ItemDataBound">
                            <LayoutTemplate>
                                <table border="0" cellpadding="0" cellspacing="0" class="listViewTable">
                                    <tr>
                                        <th>                                            
                                            <asp:LinkButton ID="uoLinkButtonBrand" runat="server" CommandName="colVendorBranchNameVarchar"
                                                Text="Brand"></asp:LinkButton>
                                        </th>
                                        <th>
                                            <asp:LinkButton ID="uoLinkButtonBranch" runat="server" CommandName="SortByBranchName"
                                                Text="Branch"></asp:LinkButton>
                                        </th>
                                        <th>                                            
                                             <asp:LinkButton ID="uoLinkButtonCountry" runat="server" CommandName="country"
                                                Text="Country"></asp:LinkButton>
                                        </th>
                                        <th>                                            
                                             <asp:LinkButton ID="uoLinkButtonCity" runat="server" CommandName="city"
                                        ...
                                        <th runat="server" style="width: 12%" id="THDelete">
                                        </th>
                                    </tr>
                                ...
                                <asp:TextBox ID="uoTextBoxPriority" runat="server" Width="60px" CssClass="SmallTextCenter" Text='<%# Eval("Priority")%>' Orig='<%# Eval("Priority")%>' 
                                 visible='<%# (Convert.ToBoolean(uoHiddenFieldViewPriority.Value)) %>' onkeypress="return validate(event);"></asp:TextBox>
                                    ...
                                    <td runat="server" id="PriorityTR">
                                        <asp:TextBox ID="uoTextBoxPriority" runat="server" Width="60px" CssClass="SmallTextCenter"
                                            Text='<%# Eval("Priority")%>' Orig='<%# Eval("Priority")%>' onkeypress="return validate(event);"></asp:TextBox>
                                    </td>
                                    <td class='<%# uoHiddenFieldVendorClass.Value  %>'>
                                        <asp:LinkButton ID="uoLinkButtonDelete" runat="server" CommandName="Delete" CommandArgument='<%# Eval("colAirportIdInt") + "::" + Eval("colBranchIDInt") %>'
                                            OnClientClick="javascript: return confirmDelete();">Delete</asp:LinkButton>
                        ...
                        <asp:ObjectDataSource ID="uoObjectDataSourceHotel" runat="server" OnSelecting="uoObjectDataSourceHotel_Selecting"
                            ...
                            TypeName="TRAVELMART.BLL.MaintenanceViewBLL" OldValuesParameterFormatString="oldcount_{0}"
                            EnablePaging="True" OnDeleting="uoObjectDataSourceHotel_Deleting" DeleteMethod="RemoveHotelInAirportNoUse">
                            <SelectParameters>
                                ...
                                <asp:Parameter Name="iRoomType" Type="Int16" />
                            </SelectParameters>

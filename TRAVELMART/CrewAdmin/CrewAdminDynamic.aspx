<%@ Page Title="" Language="C#" MasterPageFile="~/TravelMartMaster2.Master" AutoEventWireup="true"
    CodeBehind="CrewAdminDynamic.aspx.cs" Inherits="TRAVELMART.CrewAdminDynamic.CrewAdminDynamic" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="NaviPlaceHolder" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function filterSettings() {
            ...
            $("#<%=uoCheckBoxSelectAllOFF.ClientID %>").click(function(ev) {
                if ($(this).attr('checked')) {
                    var sURL = '../Vehicle/VehicleEditor2.aspx?AddCancel=Add&IsFromCrewAdmiAll=1&RecLoc=0&TReqID=0&TransID=0';
    ...
    <div id="PG" style="width: auto; height: auto; overflow: auto;">
                    ...
                    <td style="width: 250px; text-align: left; white-space: nowrap">
                        <table>
                            ...
                            <tr>
                                <td></td>
                                <td colspan="2">
                                    <asp:CheckBox ID="uoCheckBoxSelectAllOFF" runat="server" Text="Add all OFF in Transportation" Checked="false"/>
                                </td>
                                <td>
        ...
        <div id="Av" style="overflow: auto; overflow-x: hidden; width: 100%; overflow-y: hidden;">
            <asp:ListView runat="server" ID="ListView1" 
                OnItemCommand="uoListViewCrewAdmin_ItemCommand" >
                <LayoutTemplate>
                    ...
                    <table width="100%">
                        <tr>
                            <td style="text-align: left">
                                <asp:ListView runat="server" ID="uoListViewCrewAdmin" OnItemCommand="uoListViewCrewAdmin_ItemCommand">
                                    <LayoutTemplate>
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <td class="centerAligned" style="white-space: normal;" >
                                            <asp:Label Width="70px" ID="Label16" runat="server" Text="" ></asp:Label>
                                         ...
                                         <td class="centerAligned" style="white-space: normal;" >
                                            ...
                                            Visible='<%#  Eval("IsCheckBoxForVehicleVisible") %>' Checked='<%# Eval("IsVisibleToVehicleVendor") %>' 
                                            OnClick='CheckUncheckNeedTransport();' />
                                            <%--OnClick='<%# "CheckUncheckNeedTransport(this,"+ Eval("IDBigInt") + "," + Eval("TravelRequestID") +");" %>' />--%>
                                        </td>
                                        <td class="centerAligned" style="white-space: normal;">
                                            <asp:Label runat="server" ID="Label4" Width="50px" Text='<%# Eval("SequenceNo")%>' />
                                        </td>
                                        <td class="leftAligned" style="white-space: normal;">
                                            <asp:Label runat="server" ID="Label8" Width="70px" Text='<%# Eval("RouteFrom")%>'  Visible='<%# Eval("IsVisible") %>'></asp:Label>
                                        </td>
                                        <td class="leftAligned" style="white-space: normal;">
                                            <asp:Label runat="server" ID="Label9" Width="70px" Text='<%# Eval("RouteTo")%>'  Visible='<%# Eval("IsVisible") %>'></asp:Label>
                                        </td>
                                        <td class="leftAligned" style="white-space: normal;">
                                            <asp:Label runat="server" ID="Label14" Width="100px" Text='<%# String.Format("{0:dd-MMM-yyyy HHmm}", Eval("PickupDatetime"))%>'  Visible='<%# Eval("IsVisible") %>'></asp:Label>
                                        </td>                                        
                                        <td class="leftAligned" style="white-space: normal;">
                                        ...
                                        <td class="leftAligned" style="white-space: normal;">
                                            <asp:Label runat="server" ID="Label15" Width="90px" Text='<%# Eval("PassportNo")%>'
                                                Visible='<%# Eval("IsVisible") %>'></asp:Label>
                                        </td>
                                        <td class="leftAligned" style="white-space: normal;">
                                            <asp:Label runat="server" ID="Label19" Width="90px" Text='<%# Eval("PassportIssued")%>'
                                                Visible='<%# Eval("IsVisible") %>'></asp:Label>
                                        </td>
                                        <td class="leftAligned" style="white-space: normal;">
                                        ...
                                        <td class="leftAligned" style="white-space: normal;">
                                            <asp:Label runat="server" ID="Label28" Width="150px" Text='<%# Eval("Remarks") %>'
                                                Visible='<%# Eval("IsVisible") %>'></asp:Label>
                                        </td>
                                        </tr>
                                    </ItemTemplate>

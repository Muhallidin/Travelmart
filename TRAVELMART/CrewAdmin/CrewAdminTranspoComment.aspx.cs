...
{
    public partial class CrewAdminTranspoComment : System.Web.UI.Page
    {
        #region "Events"
        /// <summary>
        ...
        /// Description:    Bind uoListViewAdded
        /// ------------------------------------------
        /// </summary>
        protected void BindTranspo()
        {
            try
            {
                ...
                uoListViewAdded.DataSource = list;
                uoListViewAdded.DataBind();
        ...
        /// </summary>
        private void GetVehicleToAddCancel()
        {
            DataTable dt = null;
            try
            {
                ...
                else
                {
                    ...
                    //    "AddCancelTranspo", Path.GetFileName(Request.Path), CommonFunctions.GetDateTimeGMT(currentDate), DateTime.Now);
        ...
        /// </summary>
        private void AddCancelVehicle()
        {
            try
            {
                //DateTime currentDate = CommonFunctions.GetCurrentDateTime();
                //CrewAdminBLL.AddCancelVehicleManifest(uoTextBoxComment.Text, uoTextBoxPickupDate.Text, uoTextBoxPickupTime.Text,
                //    uoHiddenFieldUser.Value, uoTextBoxEmailAdd.Text, uoTextBoxCopy.Text, "",
                //    "Add/Cancel Transport in Crew Admin Page",
                //    "AddCancelVehicle", Path.GetFileName(Request.Path), CommonFunctions.GetDateTimeGMT(currentDate), DateTime.Now);
            }
            catch (Exception ex)
            {
                throw ex;

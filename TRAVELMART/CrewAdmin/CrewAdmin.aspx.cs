...
{
    public partial class CrewAgent : System.Web.UI.Page
    {
        #region Events
...
//                uoCheckBoxSelectAllOFF.Checked = false;
        ...
        protected void uoObjectDataSourceCrewAdmin_Selecting(object sender, ObjectDataSourceSelectingEventArgs e)
        {
            ...
            e.InputParameters["VesselID"] = GlobalCode.Field2Int(Session["VesselID"]);
        ...
        protected void uoListViewCrewAdminHeader_ItemCommand(object sender, ListViewCommandEventArgs e)
        {
        ...
        {
            Session["VesselID"] = uoDropDownListVessel.SelectedValue;
            //BindManifest();  
            uoHiddenFieldLoadType.Value = "1";
        ...
        protected void InitializeValues()
        {
            ...
            uoListViewCrewAdminHeader.DataSource = null;
            uoListViewCrewAdminHeader.DataBind();
        }
        /// <summary>
        ...
        private void BindVessel()
        {
            ...
            if (Session["CrewAdminVessel"] != null)
            {
                list = (List<VesselDTO>)Session["CrewAdminVessel"];
            }
            ...
            uoDropDownListVessel.Items.Insert(0, new ListItem("--Select Ship--", "0"));
            ...
            {
                int iVesselID = GlobalCode.Field2Int(Session["VesselID"]);
                if (uoDropDownListVessel.Items.FindByValue(iVesselID.ToString()) != null)
                {
                    uoDropDownListVessel.SelectedValue = iVesselID.ToString();
                }
            }
            Session["VesselID"] = uoDropDownListVessel.SelectedValue;
        }
                                ...
                                else
                                {
                                    if (i <= iColCount)
                                    {
                                        ...
                                        if (dtSource.Columns[i - 1].Caption.ToUpper() == "AIR SEQUENCE" ||
                                            ...
                                            dtSource.Columns[i - 1].Caption.ToUpper() == "FLIGHT NO."  ||                                            
                                            dtSource.Columns[i - 1].Caption.ToUpper() == "VEHICLE STATUS"                                               
                                            )                                            
                                        {
                                            // Write content of cell
                                            ...
                                            dtSource.Columns[i - 1].Caption.ToUpper() == "VEHICLE CO." ||
                                            dtSource.Columns[i - 1].Caption.ToUpper() == "ROUTEFROM"  ||
                                            dtSource.Columns[i - 1].Caption.ToUpper() == "ROUTETO"  ||
                                            dtSource.Columns[i - 1].Caption.ToUpper() == "PICKUPDATE" ||
                                            dtSource.Columns[i - 1].Caption.ToUpper() == "ISNEEDTRANSPORT")
                                        {
                                            // Write content of cell
                                            xtwWriter.WriteValue(GlobalCode.Field2String(cellValue).ToString());
                                        }
                                        else
                                        {
        ...
        {
            string strScript = "CloseModal('../Extract/CrewAdmin/" + strFileName + "');";

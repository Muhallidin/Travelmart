<%@ Page Title="" Language="C#" MasterPageFile="~/TravelMartMaster2.Master" AutoEventWireup="true" CodeBehind="CrewAdmin.aspx.cs" Inherits="TRAVELMART.CrewAgent.CrewAgent" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function CheckALLNeedTransport(obj) {
            ...
            $("#ucTableCrewAdmin tr").each(function(i, element) {
                ...
                var chk = $('td:eq(2) input[name*="uoCheckBoxNoVehicleNeed"]', this);                

                var TransID = $('td:eq(2) input[name*="uoHiddenFieldTransID"]', this);
        ...
        function CheckUncheckNeedTransport() {
            ...
            $("#ucTableCrewAdmin tr").each(function(i, element) {
                ...
                var RecLocID = $('td:eq(2) input[name*="uoHiddenFieldListRecLocID"]', this);
                var TravelReqID = $('td:eq(2) input[name*="uoHiddenFieldListTRID"]', this);
                var TransID = $('td:eq(2) input[name*="uoHiddenFieldTransID"]', this);
        ...
        function CheckUncheckEditransport() {
            ...
            $("#ucTableCrewAdmin tr").each(function(i, element) {
                var $TDs = $(this).find('td');
                var chk = $('td:eq(1) input[name*="uoCheckBoxEditVehicle"]', this);
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" class="listViewTable" runat="server" id = "ucTableHeader">
                        <tr>
                         ...
                         <%--   <th style="text-align: center; white-space: normal;">
                           ...
                           <%-- <th style="text-align: center; white-space: normal;">
                               <asp:LinkButton ID="LinkButton41" Text="Actual Departure Time" Width="150px" runat="server" CommandName="colDepartureDateTime" />
                            </th>      --%>             
                          ...
                          <%-- 
                            <th style="text-align: center; white-space: normal;">
                                <asp:LinkButton ID="LinkButton37" Text="Actual Arrival Time" Width="150px" runat="server" CommandName="colDepartureDateTime" />
                            </th>   --%>                                                       
                          ...
                          <%--  
                            <th style="text-align: center; white-space: normal;">
                                <asp:LinkButton ID="LinkButton38" Text="Arrival Gate" Width="60px" runat="server" CommandName="colDepartureDateTime" />
                            </th> 
                            <th style="text-align: center; white-space: normal;">
                                <asp:LinkButton ID="LinkButton39" Text="Flight Status" Width="60px" runat="server" CommandName="colDepartureDateTime" />
                            </th>                            
                             <th style="text-align: center; white-space: normal;">
                                <asp:LinkButton ID="LinkButton40" Text="Baggage Claim" Width="60px" runat="server" CommandName="colDepartureDateTime" />
                            </th>         --%>                     
                            ...
                            <th style="text-align: center; white-space: normal;">
                             ...
                             <th style="text-align: center; white-space: normal;">
                                <asp:Label runat="server" ID="lblHDateHired" Text="Date Hired" Width="95px"></asp:Label>
                            </th>
                            ...
                            <td style="text-align: left">
                                <asp:ListView runat="server" ID="uoListViewCrewAdmin">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <td class="leftAligned" style="white-space: normal;">
                                            <asp:Label runat="server" ID="uoLblReason" Width="200px" Text='<%# Eval("Hotel")%>' Visible='<%# Eval("IsVisible") %>'></asp:Label>
                                        </td>
                                        <td class="leftAligned" style="white-space: normal;">
                                  ...
                                  <%--  <td class="leftAligned" style="white-space:normal;">
                                            <asp:Label runat="server" ID="Label29" Width="156px" Text='<%# Eval("ActualDepartureDate")%>'></asp:Label>
                                        </td>       --%>                                 
                                   ...
                                   <%--        <td class="leftAligned" style="white-space: normal;">
                                        <asp:Label runat="server" ID="Label26" Width="156px" Text='<%# Eval("ActualArrivalDate")%>'></asp:Label>
                                        </td> --%>
                                ...
                                <%--    <td class="leftAligned" style="white-space: normal;">
                                         <asp:Label runat="server" ID="Label27" Width="66px" Text='<%#  Eval("ActualArrivalGate")%>'></asp:Label>
                                        </td>
                                        <td>
                                        <asp:Label runat="server" ID="actualArrivalStat" Width="66px" Text='<%#  Eval("ActualArrivalStatus ")%>' ></asp:Label>
                                        </td>
                                        <td>
                                        <asp:Label runat="server" ID="ActualBaggage" Width="66px" Text='<%# Eval("ActualArrivalBaggage")%>' ></asp:Label>
                                        </td>                                        
                                                --%>                               
                                        <td class="leftAligned" style="white-space: normal;">
                                        ...
                                        <td style="text-align: center; white-space: normal;">
                                         ...
                                         <td style="text-align: center; white-space: normal;">
                                            <asp:Label runat="server" ID="lblDateHired" Text='<%# Eval("DateHired") %>' Width="100px"></asp:Label>
                                        </td>
                                        </tr>
                                    </ItemTemplate>
                                    <EmptyDataTemplate>

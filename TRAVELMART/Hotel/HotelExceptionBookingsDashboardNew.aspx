<%@ Page Title="" Language="C#" MasterPageFile="~/TravelMartMaster2.Master" AutoEventWireup="true" ValidateRequest="false"
    CodeBehind="HotelExceptionBookingsDashboardNew.aspx.cs" Inherits="TRAVELMART.Hotel.HotelExceptionBookingsDashboardNew" %>
        ...
        <table align="center" width="90%" >
            <tr>
                <td style="width: auto;" align="center">
                    <asp:HyperLink ID="uoHyperLinkDashboard" CssClass="SelectedSubMenuCss" runat="server"
                            NavigateUrl="#">Dashboard
                        </asp:HyperLink>
                      |
                      
                         <asp:HyperLink ID="uoHyperLinkTop50" CssClass="RedBgNotification" runat="server"
                            NavigateUrl="HotelExceptionBookingsTopNew.aspx">Exception Top 50
                        </asp:HyperLink>

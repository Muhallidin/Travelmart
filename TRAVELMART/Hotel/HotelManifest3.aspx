<%@ Page Title="" Language="C#" MasterPageFile="~/TravelMartMaster2.Master" AutoEventWireup="true" CodeBehind="HotelManifest3.aspx.cs" Inherits="TRAVELMART.Hotel.HotelManifest3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="server">
    <div class="PageTitle">Hotel Locked Manifest</div>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="NaviPlaceHolder" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowEmailPopup() {
            $("a#<%=uoHyperLinkSendEmail.ClientID %>").fancybox(
            {
                ...
                'type': 'iframe',
                'onClosed': function() {
                    var a = $("#<%=uoHiddenFieldPopupSendEmail.ClientID %>").val();
                    if (a == '1')
                        $("#aspnetForm").submit();
                }
            });
...
//             
            ...
            if (($("#<%=uoDropDownListBranch.ClientID %>").val() == '0') ||
                ...
                $("#<%=uoHyperLinkSendEmail.ClientID %>").attr("disabled", "disabled");
                ...
                //$("#<%=uoHyperLinkSendEmail.ClientID %>").removeAttr("disabled");
                //$("#<%=uoBtnSendEmail.ClientID %>").removeAttr("disabled"); 
                $("#<%=uoDropDownListBranch.ClientID %>").val($("#<%=uoDropDownListBranch.ClientID %>").val());
                $("#<%=uoDropDownListManifest.ClientID %>").val($("#<%=uoDropDownListManifest.ClientID %>").val());                 
            }
        }
        ...
        function filterSettings() {
            ...
            $("#<%=uoDropDownListBranch.ClientID %>").change(function(ev) {
                ...
                if ($("#<%=uoDropDownListBranch.ClientID %>").val() == '-1') {
                    $("#<%=uoDropDownListCompare.ClientID %>").hide();
                    $("#<%=uoBtnCompare.ClientID %>").hide();
                    $("#<%=uoLblCompare.ClientID %>").hide();
                }
...
//            });
        ...
        function SetCompareValue() {
            $("#<%=uoHIddenFieldCompareType.ClientID %>").val($("#<%=uoDropDownListCompare.ClientID %>").val());
        }
    </script>
    <div id="br" style="overflow: auto; overflow-x: auto; overflow-y: auto;">
    <table width="100%">
        <tr>
            <td class="LeftClass" style="width:100px;">Region :</td>
            <td class="LeftClass">
                ...
                <%--<asp:UpdatePanel runat="server" ID="uoPanelBranch" UpdateMode="Conditional">
                    <ContentTemplate>--%>
                        <asp:DropDownList runat="server" ID="uoDropDownListBranch" 
                            ...
                            <a id="uoHyperLinkSendEmail" runat="server" class="EmailLinkButton">View E-mail Address</a>
                    <%--</ContentTemplate>
                    <Triggers>
        ...
        <tr>
            <td class="LeftClass">Manifest Type :</td>
            <td class="LeftClass">
               <%-- <asp:UpdatePanel runat="server" ID="uoPanelManifestType" UpdateMode="Conditional">
                    <ContentTemplate>--%>
                        ...
                        <asp:Button runat="server" ID="uoButtonBack" Text="View Locked Summary" Width="150px"
                            CssClass="SmallButton" onclick="uoButtonBack_Click" />
                    <%--</ContentTemplate>
                </asp:UpdatePanel>--%>
            </td>
        </tr>
                ...
                <%--<asp:UpdatePanel runat="server" ID="uoPanelCompareType" UpdateMode="Conditional">
                    <ContentTemplate>--%>
                        <asp:DropDownList runat="server" ID="uoDropDownListCompare"
                            Width="300px" AppendDataBoundItems="true" onchange="return SetCompareValue();">
                            ...
                            <tr>
                                ...
                                <td class="LeftClass">
                                    <asp:Button runat="server" ID="uoBtnSearch" Text="Search"
                                        CssClass="SmallButton" onclick="uoBtnSearch_Click" Height="21px" />
                                </td>
                            </tr>
                        </table>
                    <%--</ContentTemplate>
        ...
        <tr>
            <td colspan="2" class="LeftClass">
                <%--<asp:UpdatePanel runat="server" ID="uoPanelEmail" UpdateMode="Conditional">
                    <ContentTemplate>--%>  
                        <asp:Button runat="server" ID="uoBtnExportList" CssClass="SmallButton" Text="Export Locked Manifest List"
                        ...
                        <asp:CheckBox runat="server" ID="uoChkBoxSendDiff" Text="Send with difference" /> &nbsp;
                    <%--</ContentTemplate>
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="uoBtnView" EventName="Click" />
                ...
                <asp:UpdatePanel runat="server" ID="uoPanelLocked" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:ListView ID="uoListLockedManifest" runat="server" >
                            ...
                            <ItemTemplate>
                                ...
                                <tr>
                                    ...
                                    <td class="leftAligned">
                                        <asp:HyperLink ID="uoHyperLinkName" NavigateUrl='<%# "../SuperUserView.aspx?ufn=" + Request.QueryString["ufn"] + "&sfId=" + Eval("EmployeeId") + "&recloc=" + Eval("RecordLocator") + "&st=" + Eval("Status") + "&ID=" + Eval("IdBigInt") + "&trID=" + Eval("TravelReqId ") + "&manualReqID=" + Eval("ManualReqId ") + "&dt=" + Request.QueryString["dt"]%>' runat="server"><%# Eval("FirstName")%></asp:HyperLink>
                                    </td>
                                    <td class="leftAligned">
                                        <%# Eval("EmployeeId")%>
                                    </td> 
                        ...
                        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" EnablePaging="True" 
                            ...
                            SelectCountMethod="LoadLockedManifestPagingCount2" 
                            SelectMethod="LoadLockedManifestPaging2" TypeName="TRAVELMART.BLL.LockedManifestBLL">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="uoHiddenFieldUser" 
                                    ConvertEmptyStringToNull="False" DbType="String" Name="UserId" 
                                    PropertyName="Value" />
                                <asp:ControlParameter ControlID="uoHiddenFieldLoadType" Name="LoadType" DbType="Int16" />
                                ...
                                <asp:ControlParameter ControlID="uoHiddenFieldStatus" DbType="String"
                                 ...
                                 <asp:ControlParameter ControlID="uoDropDownListRegion" DbType="Int32"
                                    ConvertEmptyStringToNull="False" Name="RegionId" PropertyName="SelectedValue" />          
                            </SelectParameters>
                ...
                <asp:UpdatePanel runat="server" ID="uoPanelDifference" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:ListView ID="uoDifferenceList" runat="server">
                            ...
                            <EmptyDataTemplate>
                                <table border="0" class="listViewTable" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td colspan="32" class="LeftClass" style="text-align:left">No Record.</td>
                                    </tr>
                                </table>
                            </EmptyDataTemplate>
                        </asp:ListView>
                        ...
                        <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" EnablePaging="True" 
                            ...
                            SelectMethod="GetDifferenceClass" TypeName="TRAVELMART.Hotel.HotelManifest3">
                           <SelectParameters>
                           </SelectParameters>
                        </asp:ObjectDataSource>
                    </ContentTemplate>
    ...
    <asp:HiddenField runat="server" ID="uoHiddenFieldLoadType" EnableViewState="true" Value="0" />
    <asp:HiddenField ID="uoHiddenFieldPopupSendEmail" runat="server" Value="0" />        
    <asp:HiddenField ID="uoHIddenFieldCompareType" runat="server" Value = "-1" />
</asp:Content>

<%@ Page Title="" Language="C#" MasterPageFile="~/Popup.Master" AutoEventWireup="true" CodeBehind="HotelEditor5.aspx.cs" Inherits="TRAVELMART.HotelEditor5" %>
...
<script type="text/javascript" src="../FBox/jquery-1.6.1.min.js"></script>
     ...
     <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       ...
       <tr style="display:none">
            ...
            <td colspan="3" style="display:none">
                ...
                <asp:RadioButtonList ID="uoVendorSelectionList" runat="server" AutoPostBack="true" style="display:none"
                RepeatDirection="Horizontal" RepeatLayout="Table" OnSelectedIndexChanged="uoVendorType_Click">
        ...
        <tr>
           ...
           <td  colspan="3">
              <asp:DropDownList ID="uoVendorDropDownList" AutoPostBack="" runat="server" OnSelectedIndexChanged="uoVendorDropDownType_Click">           
               </asp:DropDownList>
           </td>        
        </tr>
        <tr>
            ...
            <td style="white-space:nowrap" class="style2">
              <asp:TextBox runat="server" ID="uoTextBoxCheckInDate" Width="241px" ReadOnly="true" CssClass="ReadOnly"></asp:TextBox>
            </td>
            <td class="style7" > Email To:</td>
            <td style="white-space:nowrap">
               <asp:TextBox runat="server" ID="uoTextBoxEmailAdd" Width="400px"  onblur="validateMultipleEmailsSemiColonSeparated(this,';');" 
                     ToolTip="Use a semicolon (;) with no spaces to separate multiple e-mail addresses." TextMode="MultiLine" Rows="2"></asp:TextBox>
                     &nbsp;
             ...
             <tr>
                ...
                <td class="style2" >
                      ...
                      <asp:TextBox ID="uoTextBoxRateContract"  Width="80px" runat="server" 
                          ReadOnly="true" CssClass="ReadOnly dcolor">
                      </asp:TextBox>   
                      &nbsp;  
                      Single    
                      &nbsp;
                      <asp:TextBox ID="uoTextBoxRateContractSingle"  Width="80px" runat="server" 
                          ReadOnly="true" CssClass="scolor ReadOnly "></asp:TextBox>                            
             ...
             <tr>
                ...
                <td style="white-space:nowrap">
                    ...
                    <table>
                        <tr>
                             <td style="white-space:nowrap">
                                 <asp:TextBox ID="uoTextBoxRateConfirmed"  Width="70px" runat="server" onkeypress="return validate(event);"></asp:TextBox>     
                                 &nbsp;
                                 Single 
                                 &nbsp;
                                 <asp:TextBox ID="uoTextBoxSingleRateConfirmed"  Width="70px" runat="server" onkeypress="return validate(event);"></asp:TextBox>     
                                <%--  
                                   <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator6" ValidationGroup="Email" 
                                          ErrorMessage="Confirmed Rate required."  ControlToValidate="uoTextBoxRateConfirmed">* </asp:RequiredFieldValidator>   --%>
                            ...
                            <td>
                                 <asp:DropDownList ID="uoDropDownListRoom" runat="server" Width="130px" 
            ...
            <tr>
                ...
                <td  style="white-space:nowrap">                    
                    <asp:DropDownList ID="uoDropDownListRequestSource"  runat="server" Width="400px" 
                        AppendDataBoundItems="true" AutoPostBack="true" onselectedindexchanged="uoVendorDropDownType_Click">
                    </asp:DropDownList>                                                
                </td>  
            </tr>
            <tr>
                ...
                <td colspan="3">
                    <asp:Button runat="server" ID="uoButtonEmail" OnClientClick="return confimSave();"
                        Text="Create"  ValidationGroup="Email" Width="100px"
    ...
    <div id="Div2" class="PageSubTitle" style="text-decoration: underline;">
        <asp:Label ID="uoLabelSubTitle" runat="server" Text="Request Hotel List"></asp:Label>
    </div>
                ...
                <table class="listViewTable">
                    <tr>
                        ...
                        <th style="text-align: center; white-space: normal;">
                            <asp:LinkButton ID="lbnContractedRate" runat="server" CommandName="ContractedRate"
                                Text="Contracted Rate" Width="55px" />
                        </th>
                         <th style="text-align: center; white-space: normal;">
                            <asp:LinkButton ID="lbnConfirmedRate" runat="server" CommandName="ConfirmedRate"
                                Text="Confirmed Rate" Width="55px" />
                        </th>
                        ...
                        <th style="text-align: center; white-space:nowrap;">
                            <asp:LinkButton ID="uoLblNitesHeader" runat="server" CommandName="HotelNights"
    ...
    <div id="Bv" style="overflow: auto; width: 100%; overflow-x: scroll; overflow-y: auto;"
        ...
        <asp:ListView runat="server" ID="uolistviewHotelInfo" >
            ...
            <ItemTemplate>
                 ...
                 <%--<tr class='<%# Eval("SingleDouble") == "Double" ? dcolor : scolor %>'>--%>
                 <tr class='<%#  Eval("SingleDouble").ToString() == "Double" ? "dcolor" : "scolor" %>'>   
                   
                    <td class="leftAligned" style="white-space: normal;">
                        <asp:Label runat="server" ID="lblContractedRate" Text='<%# Eval("ContractedRate")%>' Width="61px"></asp:Label>
                    </td>  
                    <td class="leftAligned" style="white-space: normal;">
                        <asp:TextBox runat="server" ID="txtContractedRate" class='<%# Eval("SingleDouble").ToString() == "Double" ? "dcolor" : "scolor" %>'  Text='<%# Eval("ConfirmedRate")%>' Width="58px"></asp:Textbox>
                    </td>
                
                
                    <td class="leftAligned" style="white-space: normal;">
                        <asp:Label runat="server" ID="uoLblSfID" Text='<%# Eval("Employee")%>' Width="61px"></asp:Label>
                    </td>  
                    <td class="leftAligned" style="white-space: normal;">
                    ...
                    <td class="leftAligned" style="white-space: normal;">
                        <asp:LinkButton Width="150px" runat="server" ID="SeafarerLinkButton" PostBackUrl='<%# "../SuperUserView.aspx?sfId=" + Eval("Employee") + "&trID=" + Eval("TravelReqID") + "&recloc=" + Eval("RecLoc") + "&ID=" + Eval("IdBigint") + "&from=" + Eval("CheckIn") + "&to=" + Eval("CheckOut") + "&dt=" + Request.QueryString["dt"]%>'><%# Eval("FirstName") %></asp:LinkButton>
                    </td>      
                    
                    <%--  
                        <td class="leftAligned" style="white-space: normal;">
                            <asp:LinkButton Width="150px" runat="server" ID="LinkButton3" PostBackUrl='<%# "../SuperUserView.aspx?sfId=" + Eval("Employee") + "&trID=" + Eval("TravelReqID") + "&st=" + Eval("CrewStatus") + "&recloc=" + Eval("RecordLocator") + "&manualReqID=0&p=" + Request.QueryString["p"]+ "&ufn=" + Request.QueryString["ufn"] + "&ID=" + Eval("IdBigint") + "&from=" + Request.QueryString["from"] + "&to=" + Request.QueryString["to"] + "&dt=" + Request.QueryString["dt"]%>'><%# Eval("FirstName") %></asp:LinkButton>
                        </td>      
                    --%>
                    ...
                    <td class="leftAligned" style="white-space: normal;">
                        <asp:Label runat="server" ID="uoLblNites" Text='<%# Eval("HotelNite")%>' Width="40px"></asp:Label>
                    </td>                     
                                                                         
                    <td class="leftAligned" style="white-space: normal;">
                        <asp:Label runat="server" ID="uoLblRoom" Text='<%# Eval("SingleDouble")%>' Width="72px"></asp:Label>
                    </td>
                                                
                    <td class="leftAligned" style="white-space: normal;">
                        <asp:Label runat="server" ID="uoLblVessel" Text='<%# Eval("Ship")%>'
                  ...
                  <%--  <td class="leftAligned" style="white-space: normal;">
                    ...
                    <td class="leftAligned" style="white-space: normal;">
                        ...
                        <asp:HiddenField runat="server" ID="uoHiddenFieldTransHotelID" Value='<%# Eval("HotelTransID") %>'/>
                        <asp:HiddenField runat="server" ID="uoHiddenFieldStatusID" Value='<%# Eval("StatusID") %>'/>
                        <asp:HiddenField runat="server" ID="uoHiddenFieldIsMedical" Value='<%# Eval("IsMedical") %>'/>
    ...
    <div id="Div1" class="PageSubTitle" style="text-decoration: underline; display:none; ">
        <asp:Label ID="Label2" runat="server" Text="Cancelled Hotel Manifest"></asp:Label>
    </div>
    <div id="DivCancelHeader" style="overflow: auto; overflow-x: hidden; width: 100%;
    ...
    <div id="DivCancelDetails" style="overflow: auto; width: 100%; overflow-x: scroll;
        ...
        <asp:HiddenField ID="uoHiddenFieldVoucher" runat="server" Value="0" />
        <asp:HiddenField ID="uoHiddenFieldStatusID" runat="server" Value="0" />
    ...
    <script type="text/javascript" language="javascript">
        ...
        function setupButtonSettings() {
            ...
            $("[id$=uoTextBoxRateConfirmed]").attr('disabled', 'disabled');
            $("[id$=uoTextBoxRateConfirmed]").attr('class', 'readonly');

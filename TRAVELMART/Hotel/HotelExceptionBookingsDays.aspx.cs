...
{
    public partial class HotelExceptionBookingsDays : System.Web.UI.Page
    {
        #region DECLARATIONS
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack || uoHiddenFieldPopupCalendar.Value == "1")
            {
                ...
                DateTime dtDateSelected = GlobalCode.Field2DateTime(uoHiddenFieldDate.Value);
                DateTime dtDateLimit = GlobalCode.Field2DateTime(DateTime.Today.ToShortDateString()).AddDays((TMSettings.NoOfDays));

                if (dtDateSelected == dtDateLimit)
                {
                    uoIBtnNext.Enabled = false;
                }
            }
        ...
        private void SaveOverFlow()
        {
            ...
            {
                AlertMessage("Error Message: " + ex.Message);
            }
        }
        ...
        protected void SetDefaults()
        {
            ...
            Session.Remove("HotelTransactionExceptionExceptionBooking"); 
        ...
        private List<ExceptionBooking> GetHotelExceptionList()
        {
            try
            {
                ...
                {
                    Int16 iLoadType = GlobalCode.Field2TinyInt(HiddenFieldLoadType.Value);
                    ExceptionBLL.LoadHotelExceptionPageDays(GlobalCode.Field2DateTime(uoHiddenFieldStartDate.Value), uoHiddenFieldUser.Value,
                        GlobalCode.Field2Int(uoDropDownListRegion.SelectedValue), GlobalCode.Field2Int(uoDropDownListPortPerRegion.SelectedValue),
                        uoHiddenFieldRole.Value, iLoadType);
                    list = (List<ExceptionBooking>)Session["HotelTransactionExceptionExceptionBooking"];
                }
            ...
            try
            {
                var e = (from a in list//HotelTransactionException.ExceptionBooking
                         select new
                         {
                             ...
                             //ArvlDeptTime = string.Format("{0:HH:mm:ss}", a.ArrivalDeparturetime),
                             ArvlDeptTime = GlobalCode.Field2String(a.ArrivalDeparturetime),

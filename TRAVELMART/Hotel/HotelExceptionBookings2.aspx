<%@ Page Title="" Language="C#" MasterPageFile="~/TravelMartMaster2.Master" AutoEventWireup="true" ValidateRequest="false"
    CodeBehind="HotelExceptionBookings2.aspx.cs" Inherits="TRAVELMART.Hotel.HotelExceptionBookings2" %>
...
<asp:Content ContentPlaceHolderID="HeaderContent" runat="server" ID="header">
    <%--<div class="PageTitle">
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr class="PageTitle">
                <td align="left" style="white-space:nowrap; width: 430px">
                   Hotel Booking Exception List
                </td>      
                 <td align="right" style="text-align:right; white-space:nowrap; width: 300px">
                ...
                <td align="right">                
                    <asp:Label runat="server" ID="uoLabelRegion" Text="Region:"></asp:Label>&nbsp;&nbsp

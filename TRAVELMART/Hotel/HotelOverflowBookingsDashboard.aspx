<%@ Page Title="" Language="C#" MasterPageFile="~/TravelMartMaster2.Master" AutoEventWireup="true" ValidateRequest="false"
    CodeBehind="HotelOverflowBookingsDashboard.aspx.cs" Inherits="TRAVELMART.Hotel.HotelOverflowBookingsDashboard" %>
...
<asp:Content ContentPlaceHolderID="HeaderContent" runat="server" ID="header">
    <%--<div class="PageTitle">
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr class="PageTitle">
                <td align="left">
                   Hotel Booking Overflow Dashboard
                </td>                        
                <td align="right">                
                Region: &nbsp;&nbsp
                 ...
                 &nbsp;&nbsp;Port: &nbsp;&nbsp;
                <asp:DropDownList ID="uoDropDownListPortPerRegion" runat="server" Width="200px" 
            ...
            <%--<tr>
                <td colspan="5">
                    <asp:Label runat="server" ID="uoLabelRed" CssClass="RedNotification"
                        Text="Overflow list is based from selected month and future signon or signoff date of the year" >
                    </asp:Label>
                </td>
            </tr>--%>
            <tr>
                        ...
                        <asp:ListView runat="server" ID="ListView1" >
                            ...
                            <EmptyDataTemplate>
                                <table border="0" cellpadding="0" cellspacing="0" class="listViewTable">
                                    <tr>                                                                           
                                        <th>
                                             <asp:Label runat="server" ID="Label16" Text="Hotel Name" Width="260px"> </asp:Label>                                            
                                        </th>
                                        <th>
                                             <asp:Label runat="server" ID="Label32" Text="Hotel City" Width="90px"> </asp:Label>                                            
                                        </th>
                                        <th>
                                             <asp:Label runat="server" ID="Label30" Text="Seaport Code" Width="90px"> </asp:Label>                                            
                                        </th>
                                        <th>
                        ...
                        <ItemTemplate>     
                            <tr>                                 
                                 <td class="leftAligned" style="white-space: normal;">                                    
                                    <asp:Label runat="server" ID="Label16" Text='<%# Eval("HotelName")%>' Width="257px"> </asp:Label> 
                                 </td>
                                  <td class="leftAligned" style="white-space: normal;">                                    
                                    <asp:Label runat="server" ID="Label31" Text='<%# Eval("HotelCity")%>' Width="80px"> </asp:Label> 
                                 </td>
                                  <td class="leftAligned" style="white-space: normal;">                                    
                                    <asp:Label runat="server" ID="Label29" Text='<%# Eval("PortCode")%>' Width="80px"> </asp:Label> 
                                 </td>
                ...
                <td colspan="5">
                    <div align="left" style="text-align: left" >
                        <asp:DataPager ID="uoListViewDashboardPager" runat="server" PagedControlID="uoListViewDashboard"
                            PageSize="30" onprerender="uoListViewDashboardPager_PreRender" >
                            <Fields>
                                <asp:NumericPagerField ButtonType="link" NumericButtonCssClass="PagerClass" />                                            
                            </Fields>
                        </asp:DataPager>
                        <asp:ObjectDataSource ID="uoObjectDataSourceDashboard" runat="server" MaximumRowsParameterName="MaxRow"
                            SelectCountMethod="GetOverflowByMonthCount" SelectMethod="GetOverflowByMonthList" StartRowIndexParameterName="StartRow"
                            TypeName="TRAVELMART.BLL.OverFlowBookingBLL" OldValuesParameterFormatString="oldcount_{0}"
                            EnablePaging="True" OnSelecting="uoObjectDataSourceDashboard_Selecting">
                            <SelectParameters>
                                <asp:Parameter Name="iYear" Type="Int32" />
                                <asp:Parameter Name="iMonth" Type="Int16" />
                                <asp:Parameter Name="iRegion" Type="Int32" />
                                <asp:Parameter Name="iPort" Type="Int32" />
                                <asp:Parameter Name="sUser" Type="String" />                                
                                <asp:Parameter Name="IsPageChanged" Type="Boolean" />                                
                            </SelectParameters>
                        </asp:ObjectDataSource>
                        <asp:HiddenField runat="server" ID="uoHiddenFieldIsPageChanged" Value="false" />

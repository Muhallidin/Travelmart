...
{
    public partial class HotelNonTurnPortsPA : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (uoHiddenFieldHotelConfirm.Value == "1" || uoHiddenFieldVehicleConfirm.Value == "1")
            {
                SetDefaults();
        ...
        /// Modified Date:  04/Feb/2016
        /// Description:    Save the email to Portal Inbox 
        /// ------------------------------------------------
        /// </summary>
        private void CreateEmail(DataTable dt, DataTable dtCancelled, string sEmailTo, string sEmailCc)
        {
            try
            {
                ...
                if (sEmailArray.Count() > 0 || sEmailCCArray.Count() > 0)
                {
                    ...
                    string sModuleID = GlobalCode.Field2Int(PortalBLL.GetPortalModuleID("NTP")).ToString();

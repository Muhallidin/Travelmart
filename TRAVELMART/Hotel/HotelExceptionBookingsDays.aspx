<%@ Page Title="" Language="C#" MasterPageFile="~/TravelMartMaster2.Master" AutoEventWireup="true" ValidateRequest="false"
    CodeBehind="HotelExceptionBookingsDays.aspx.cs" Inherits="TRAVELMART.Hotel.HotelExceptionBookingsDays" %>
...
<asp:Content ContentPlaceHolderID="HeaderContent" runat="server" ID="header">
    <%--<div class="PageTitle">
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr class="PageTitle">
                <td align="left">
                   Hotel Booking Exception List (up to 6 days)
                </td>                        
                <td align="right">                
                Region: &nbsp;&nbsp
...
//            $("#<%=uoHiddenFieldNoOfNites.ClientID %>").val(d);
    ...
    <asp:HiddenField runat="server" ID="HiddenFieldLoadType" EnableViewState="true" Value="0" />
    <asp:HiddenField runat="server" ID="uoHiddenFieldRole" EnableViewState="true" Value="" />

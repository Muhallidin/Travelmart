<%@ Page Title="" Language="C#" MasterPageFile="~/Popup.Master" AutoEventWireup="true" CodeBehind="HotelExceptionBookingsRemoved.aspx.cs" Inherits="TRAVELMART.HotelExceptionBookingsRemoved" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="PageTitle">
             Removed from Exception List
    </div>
    <hr/> 
    <div>
        <asp:Button ID="uoButtonReturn" runat="server" Text="Return to Exception List" 
    ...
    <div id="Bv" style="overflow: auto; width: 100%; overflow-x: auto; overflow-y: auto;
        ...
        <asp:ListView runat="server" ID="uoExceptionList">
            <LayoutTemplate>
            ...
            <ItemTemplate>
                ...
                <td class="hideElement">                                
                    ...
                    <asp:HiddenField runat="server" ID="hfExID" Value='<%# Eval("ExceptionIdBigInt") %>' />
                </td>

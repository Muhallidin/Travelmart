...
{
    public partial class HotelForecastMicroApprovalVendor : System.Web.UI.Page
    {
        #region Event
        /// <summary>
        ...
        {
            Session["NoOfDays_Forecast"] = uoDropDownListDays.SelectedValue;
        ...
        private void BindNoOfDays()
        {
            if (GlobalCode.Field2String(uoDropDownListDays.SelectedValue) == "")
            {
                ...
                int iNoOfdays = TMSettings.NoOfDaysForecast;
                ListItem item;
                ...
                {
                    string sDay = GlobalCode.Field2Int(Session["NoOfDays_Forecast"]).ToString();

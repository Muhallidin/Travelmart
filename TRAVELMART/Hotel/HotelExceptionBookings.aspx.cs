...
{
    public partial class HotelExceptionBookings : System.Web.UI.Page
    {
        ...
        private void HidePopUp()
        {
            ...
            sScript +=  "$(\"#aspnetForm\").submit();";
            sScript += " $(\"#<%= uoHiddenFieldRemoveFromList.ClientID %>\").val(\"1\");";
            sScript += "</script>";
        ...
        /// </summary>
        /// <returns></returns>
        protected void uoButtonRemovedException_click(object sender, EventArgs e)
        {
            try
            {
                HidePopUp();
                ...
                uoOverflowList.DataSource = null;

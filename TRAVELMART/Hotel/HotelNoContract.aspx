<%@ Page Title="" Language="C#" MasterPageFile="~/TravelMartMaster2.Master" AutoEventWireup="true" ValidateRequest="false"
    CodeBehind="HotelNoContract.aspx.cs" Inherits="TRAVELMART.Hotel.HotelNoContract" %>
...
<asp:Content ContentPlaceHolderID="HeaderContent" runat="server" ID="header">
    <%--<div class="PageTitle">
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr class="PageTitle">
                <td align="left">
                   No Hotel Contract Exception List
                </td>                        
                <td align="right">                
                Region: &nbsp;&nbsp
        ...
        <tr>
            <td>
                <asp:UpdatePanel runat="server" ID="uoUpdateExport" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Button runat="server" ID="uoBtnExportList" CssClass="SmallButton" Text="Export No Contract Hotel Exception List"
            ...
            <EmptyDataTemplate>
                <table border="0" cellpadding="0" cellspacing="0" class="listViewTable">
                    <tr>
                        ...
                        <th class="MouseTool" style="text-align: center;">
                            <asp:Label runat="server" ID="Label9" Text=" Exception Remarks" Width="250px"> </asp:Label>
                        </th>
                        <th class="MouseTool" style="text-align: center;">
                ...
                <table border="0" cellpadding="0" cellspacing="0" class="listViewTable">
                    <tr>
                        <td colspan="20" class="leftAligned">
                            <asp:Label runat="server" ID="Label10" Text="No Records" Width="1910px"> </asp:Label>
                        </td>
                    </tr>
                </table>
            </EmptyDataTemplate>
...
<asp:Content ID="Content3" ContentPlaceHolderID="BodyPlaceHolder" runat="server">
    ...
    <br />
    <div style="overflow: auto; overflow-x: auto; overflow-y: auto; text-align: left; padding-top: 3px; position:relative;" id="HotelDiv">
                    ...
                    <asp:Panel runat="server" ID="uoPanelBranchName" BorderColor="#ECDFC4" Width="100%"
                        ...
                        <table width="100%" runat="server" id="uoTblDetails">
                                        ...
                                        <LayoutTemplate>
                                            <table border="0" cellpadding="0" cellspacing="0" class="listViewTable">
                                                <tr>
                                                    ...
                                                    <th style="white-space: normal;">
                                                        <asp:Label runat="server" ID="uoLblCrewHdr" Text="Booked Crew" Width="40px"></asp:Label>
                                                    </th>
                                                    <th colspan="5" style="white-space: normal;">
                            ...
                            <tr id="Tr2" visible='<%# !Convert.ToBoolean(Eval("isAccredited")) %>' runat="server">
                                ...
                                <td class="LeftClass">
                                    <asp:RadioButtonList runat="server" ID="uoRBtnAllocations" RepeatDirection="Horizontal">
                                        <asp:ListItem Selected="True" Text="Contract" Value="0"></asp:ListItem>
                            ...
                            <tr>
                                ...
                                <td class="LeftClass" style="padding-left: 4px;">
                                    <asp:TextBox runat="server" ID="uoTxtBoxCheckIn" Height="22px" Width="65px" 
                                        onchange="return OnDateChange(this);"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td class="LeftClass" style="padding-left: 4px;">
                                    <asp:TextBox runat="server" ID="uoTxtBoxDays" Text="1" Width="90px" MaxLength="3"
                                        onkeyup="validateDays();" onkeypress="return validate(event);" onchange="GetNoOfNites(this)"></asp:TextBox>

...
{
    public partial class HotelOverflowBookingsDashboard : System.Web.UI.Page
    {
        OverFlowBookingBLL BLL = new OverFlowBookingBLL();

        #region "Events"
        /// <summary>
        /// Author:             Josephine Monteza
        /// Date Created:       30/Oct/2014
        /// Description:        Load the page for Overlfow count
        /// </summary>
        ...
        protected void uoButtonView_Click(object sender, EventArgs e)
        {
            ...
            uoHiddenFieldIsPageChanged.Value = "false";
            uoListViewDashboardPager.SetPageProperties(0, uoListViewDashboardPager.PageSize, false);  
            BindDashboard();
        }
        ...
        protected void uoListViewDashboardPager_PreRender(object sender, EventArgs e)
        {
            uoHiddenFieldIsPageChanged.Value = "true";
            //BindDashboard();
        }
        #endregion
        ...
        //    list = OverFlowBookingBLL.GetOverflowByMonth(iYear, iMonth, iRegion, iPort, uoHiddenFieldUser.Value, 0, 0, uoListViewDashboard.Page);
        ...
        protected void CreateFile(DataTable dt)
        {
            try
            {
                ...
                string FileName = "OverflowByDashboard_" + sDate + ".xls";
        ...
        /// Author:         Josephine Gad
        /// Date Created:   30/Oct/2014
        /// Description:    Get Overflow List to export
        /// </summary>
        private void ExportOverflow()
        {
            DataTable dt = null;
            try
            {
                dt = BLL.GetOverflowByMonthExport(uoHiddenFieldUser.Value);
                if (dt.Rows.Count > 0)
                {
                    CreateFile(dt);
                }

<%@ Page Title="" Language="C#" MasterPageFile="~/TravelMartMaster2.Master" AutoEventWireup="true" ValidateRequest="false"
    CodeBehind="HotelExceptionBookingsTopNew.aspx.cs" Inherits="TRAVELMART.Hotel.HotelExceptionBookingsTopNew" %>
...
<asp:Content ContentPlaceHolderID="HeaderContent" runat="server" ID="header">
    <%--<div class="PageTitle">
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr class="PageTitle">
                <td align="left">
                   Top Hotel Booking Exception List
                </td>                        
                <td align="right">                
                Region: &nbsp;&nbsp
                ...
                <td style="width: auto;" align="center">
                    <asp:HyperLink ID="uoHyperLinkDashboard" CssClass="RedBgNotification" runat="server"
                      ...
                      |
                         ...
                         <asp:HyperLink ID="uoHyperLinkTop50" CssClass="SelectedSubMenuCss" runat="server"
                            NavigateUrl="#">Exception Top 50
                        </asp:HyperLink>
                        
                      |
                      
                         <asp:HyperLink ID="uoHyperLinkNonTurn" CssClass="RedBgNotification" runat="server"
...
//            $("#<%=uoHiddenFieldNoOfNites.ClientID %>").val(d);
                            ...
                            <tr id="Tr2" visible='<%# !Convert.ToBoolean(Eval("isAccredited")) %>' runat="server">
                                ...
                                <td class="LeftClass" style="padding-left: 4px;">
                                    <asp:TextBox runat="server" ID="uoTxtBoxCheckIn" Height="22px" Width="65px" 
                                        onchange="return OnDateChange(this);"></asp:TextBox><cc1:TextBoxWatermarkExtender ID="uoTxtBoxCheckIn_TextBoxWatermarkExtender" runat="server"
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ID="rfvCheckIn" ValidationGroup="Save"
                                        ErrorMessage="Check In date required." ControlToValidate="uoTxtBoxCheckIn">*</asp:RequiredFieldValidator><asp:Button runat="server" ID="uoBtnCheckRooms" Text="Check Rooms" Width="100px"
    ...
    <div id="ucDivComment">
       <table border="0" cellpadding="0" width="100%">
        ...
        <tr>
            <td colspan="4">
            <asp:Button ID="uoButtonRemove" runat="server" Text="Submit" CssClass="SmallButton"  

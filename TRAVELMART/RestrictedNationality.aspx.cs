...
{
    public partial class RestrictedNationality : System.Web.UI.Page
    {
        #region "Events"
        /// <summary>
        ...
        protected void uoBtnSaveToExcel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                dt = TRBLL.GetTRRestrictedNationalityExport(uoHiddenFieldUser.Value);
        ...
        protected void CreateFile(DataTable dt)
        {
            ...
            {
                string FileName = "RestrictedNatl_" + sDate + ".xls";
                    ...
                    foreach (object cellValue in row.ItemArray)
                    {
                        ...
                        else
                        {
                            if (i <= iColCount)
                            {
                                ...
                                xtwWriter.WriteStartElement("Data");
                                if (dtSource.Columns[i].Caption.ToUpper() == "E1 ID")
                                {

...
{
    public partial class PortAgentConfirmCancelManifest : System.Web.UI.Page
    {
        ...
        public void OnEndComboExceptions(IAsyncResult ar)
        {
            ...
            int iStatusID = GlobalCode.Field2TinyInt(uoDropDownListStatus.SelectedItem.Value); 
            string sType = "New";
            int iPortAgentID = GlobalCode.Field2TinyInt(uoDropDownListPortAgent.SelectedItem.Value);
            string sDate = uoHiddenFieldDate.Value;
            string sUserID =  uoHiddenFieldUser.Value;
            string sRole = uoHiddenFieldRole.Value;
            string sOrderBy = uoHiddenFieldRole.Value; 
            short iLoadType = 0;
            int iNoOfDay = GlobalCode.Field2TinyInt(uoDropDownListDays.SelectedItem.Value);
            long iSFID = 0;
            int iStartRow=0 ; 
            int iMaxRow = 50;
             ...
             GetHotelConfirmManifestList( iStatusID,  sType,  iPortAgentID,  sDate,  sUserID,
             sRole,  sOrderBy,  iLoadType,  iNoOfDay,  iSFID,  iStartRow,  iMaxRow);
        ...
        private void BindHotelManifest(Int16 iLoadType)
        {
            ...
            object test = uoObjectDataSourceManifest.UniqueID;
            test = uoObjectDataSourceManifest.UniqueID;

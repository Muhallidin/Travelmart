<%@ Page Title="" Language="C#" MasterPageFile="~/TravelMartMaster2.Master" AutoEventWireup="true" 
    CodeBehind="PortAgentConfirmCancelManifest.aspx.cs" Inherits="TRAVELMART.PortAgent.PortAgentConfirmCancelManifest" %>

<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="server">
    <table width="100%" cellpadding="0" cellspacing="0" class="LeftClass" style="height:25px">
        <tr class="PageTitle">
            <td align="left" style="vertical-align:middle; vertical-align:middle">
                <asp:Label ID="uoLabelTitle" runat="server" class="Title" Text="Service Provider Hotel Manifest"></asp:Label>
            </td>  
...
<asp:Content ID="Content3" ContentPlaceHolderID="NaviPlaceHolder" runat="server">
    <table width="100%" cellpadding="0" cellspacing="0" class="LeftClass">  
        <tr>
            <td style ="white-space:nowrap; ">
                ...
                <a id="linkConfirm" href="PortAgentHotelEditor.aspx" runat="server" >
                   <asp:Button runat="server" ID = "uoButtonConfirm" Text="Confirm" CssClass="SmallButton" Width="100px" OnClientClick="javascript: return false;"/>                    
                </a>
                
                <a id="linkCancel" href="PortAgentHotelEditor.aspx" runat="server" >
                   <asp:Button runat="server" ID = "uoButtonCancelVendor" Text="Cancel" CssClass="SmallButton" Width="100px" OnClientClick="javascript: return false;"/>
                </a>
                
                <a id="linkEditAmount" href="PortAgentHotelEditor.aspx" runat="server" >
                   <asp:Button runat="server" ID = "uoButtonEdit" Text="Edit Amount" CssClass="SmallButton" Width="100px" OnClientClick="javascript: return false;"/>                 
                </a>
                <a id="linkApprove" href="PortAgentHotelEditor.aspx" runat="server" >
                   <asp:Button runat="server" ID = "uoButtonApprove" Text="Approve" CssClass="SmallButton" Width="100px" OnClientClick="javascript: return false;"/>
                </a>
                <a id="linkCancelRCCL" class="clsLinkCancelRCCL" href="PortAgentHotelEditor.aspx" runat="server" >
                    <asp:Button runat="server" ID = "uoButtonCancelRCCL" Text="Cancel" CssClass="SmallButton" Width="100px" OnClientClick="javascript: return false;"/>
                </a>      
                          
            </td>
            <td style ="white-space:nowrap; width:100%; padding:0px 0px 0px 20px; ">
   ...
   <%--Hotel Service Manifest--%>
    ...
    <div id="uoDivHotelManifest"  >   
        <p style=" text-align:left; padding-left:10px; font-weight:bold;" > Confirmed Hotel Manifest </p>      
        <table width="100%" cellpadding="0" cellspacing="0" class="LeftClass">
            <tr>
                <td>                 
                            ...
                            <table class="listViewTable">
                                <tr>     
                                    <th style="text-align: center; white-space: normal;">
                                        <asp:Label ID="uoLabeApprove" runat="server" Text="Select" Width="50px" />
                                    ...
                                    <th style="text-align: center; white-space: normal;">
                                        <asp:LinkButton ID="LinkButton8" runat="server" CommandName="CostCenter" Text="Nationality"
                                            Width="100px" />
                                    </th>
                                    <th style="text-align: center; white-space: normal;">
                                    ...
                                    <th style="text-align: center; white-space: normal;">
                                        <asp:LinkButton ID="uoLblDTimeHeader" runat="server" CommandName="DeptTime"
                                            Text="Dept Time" Width="56px" />
                                    </th>
                                    <!--
                                    <th style="text-align: center; white-space: normal;">
                                         <asp:LinkButton ID="LinkButton13" runat="server" CommandName="ArvlTime"
                                            Text="Actual Departure Time" Width="53px" />                                     
                                    </th>         
                                    
                                    -->                           
                                    <th style="text-align: center; white-space: normal;">
                                        <asp:LinkButton ID="uoLblATimeHeader" runat="server" CommandName="ArvlTime"
                                            Text="Arvl Time" Width="56px" />
                                    </th>
                                    <!--
                                    <th style="text-align: center; white-space: normal;">
                                         <asp:LinkButton ID="LinkButton9" runat="server" CommandName="ArvlTime"
                                            Text="Actual Arrival Time" Width="53px" />                                                                       
                                    </th>
                                     -->
                                    <th style="text-align: center; white-space: normal;">
                                    ...
                                    <!--
                                    <th style="text-align: center; white-space: normal;">
                                        <asp:LinkButton ID="LinkButton10" runat="server" CommandName="ArvlTime"
                                            Text="Arrival Gate" Width="56px" />                                 
                                    </th>
                                    <th style="text-align: center; white-space: normal;">
                                          <asp:LinkButton ID="LinkButton11" runat="server" CommandName="ArvlTime"
                                            Text="Flight Status" Width="56px" />                                  
                                    </th>
                                    <th style="text-align: center; white-space: normal;">
                                            <asp:LinkButton ID="LinkButton12" runat="server" CommandName="ArvlTime"
                                            Text="Baggage Claim" Width="56px" />                               
                                    </th>                                    
                                    -->
                                    <th style="text-align: center; white-space: normal;">
                                    ...
                                    <th style="text-align: center; white-space: normal;">
                                        <asp:Label ID="Label2" runat="server"  Text="Commented By" Width="105px" />
                                    </th>
                                    <th style="text-align: center; white-space: normal;">
                                        <asp:Label ID="lblRemarkHeader" runat="server"  Text="Booking Remark" Width="105px" />
                                    </th>
                                   <th style="text-align: center; white-space: normal;">
                                        <asp:Label runat="server" ID="Label20" Text="" Width="25px"></asp:Label>
                                    </th>
                                </tr>
                            </table>
                        </EmptyDataTemplate>
                ...
                <div id="Bv" style="overflow: auto; width: 100%; overflow-x: scroll; overflow-y: auto;" onscroll="divScrollL();">
                    ...
                    <asp:ListView runat="server" ID="uolistviewHotelInfo" OnDataBound="uolistviewHotelInfo_DataBound"  
                        ...
                        <ItemTemplate>
                            ...
                            <tr>   
                                ...
                                <td runat="server" id= "TagTD">
                                    ...
                                    <asp:Label ID="Label12" Width="50px" runat="server" Text="" Visible='<%# ((!Convert.ToBoolean(Eval("IsTagged")) && !Convert.ToBoolean(Eval("IsVendor"))) == true? true: false)%>'></asp:Label>
                                ...
                                <td class="leftAligned" style="white-space: normal;">
                                    <asp:Label runat="server" ID="uoLabelStatus" Text='<%# Eval("RequestStatus")%>' Width="65px"></asp:Label>
                                </td>  
                                 <td class="leftAligned" style="white-space: normal;">
                                ...
                                <td class="leftAligned" style="white-space: normal;">
                                    <asp:Label runat="server" ID="Label7" Text='<%# Eval("Nationality")%>' Width="110px"></asp:Label>
                                </td>                            
                                <td class="leftAligned" style="white-space: normal;">
                                ...
                                <td class="leftAligned" style="white-space: normal;">
                                     <asp:Label runat="server" ID="Label19" Text='<%# Eval("ActualDepartureDate")%>' Width="56px"></asp:Label>      
                                </td>          -->                      
                                <td class="leftAligned" style="white-space: normal;">
                                    <asp:Label runat="server" ID="uoLblArrivalTime" Text='<%# Eval("ArvlTime")%>' Width="66px"></asp:Label>
                                </td>
                                <!--
                                <td class="leftAligned" style="white-space: normal;">
                                     <asp:Label runat="server" ID="Label15" Text='<%# Eval("ActualArrivalDate")%>' Width="56px"></asp:Label>                               
                                </td>  -->
                                ...
                                <!--
                                <td class="leftAligned" style="white-space: normal;">
                                      <asp:Label runat="server" ID="Label16" Text='<%# Eval("ActualArrivalGate")%>' Width="56px"></asp:Label>                              
                                </td>
                                <td class="leftAligned" style="white-space: normal;">
                                      <asp:Label runat="server" ID="Label17" Text='<%# Eval("ActualArrivalStatus ")%>' Width="56px"></asp:Label>                              
                                </td>
                                <td class="leftAligned" style="white-space: normal;">
                                     <asp:Label runat="server" ID="Label18" Text='<%# Eval("ActualArrivalBaggage ")%>' Width="56px"></asp:Label>                               
                                </td>   -->
                                ...
                                <td class="leftAligned" style="white-space: normal;">
                                 ...
                                 <td class="leftAligned" style="white-space: normal;">
                                     ...
                                     <asp:Label runat="server" ID="lblRemarkList" Text='<%# Eval("Remark")%>'  
                                        Width="105px"></asp:Label>
    ...
    <br />
     <%--Hotel Cancel Service Manifest--%>
     
     <div id="uoDivCancelledManifest" >   
        <p  style="text-align:left; padding-left:10px; font-weight:bold;" >Cancelled Hotel Manifest </p>    
        <table width="100%" cellpadding="0" cellspacing="0" class="LeftClass">
            <tr>
                <td>                 
                    <div id="Div2" style="overflow: auto; overflow-x: hidden; width: 100%; overflow-y: hidden;">
                        ...
                        <EmptyDataTemplate>
                            <table class="listViewTable">
                                <tr>     
                                    ...
                                    <th runat="server" id="TagTH" style="display:none;">
                                        <asp:Label runat="server" ID="Label7" Text="Tagged" Width="50px" ></asp:Label>
                                    </th>
                                    <th style="text-align: center; white-space: normal; display:none;">
                                        <asp:LinkButton ID="LinkButton5" runat="server" CommandName="RequestStatus"
                ...
                <div id="Div3" style="overflow: auto; width: 100%; overflow-x: scroll; overflow-y: auto;"
                    onscroll="divScrollL();">
                    <asp:ListView runat="server" ID="uoListViewCancelledManifest" 
                        ...
                        <ItemTemplate>
                            ...
                            <tr>   
                                ...
                                <td runat="server" id= "TagTD" style="display:none;">
                                    <asp:Label ID="Label26" Width="50px" runat="server" Text="Tagged" Visible='<%# Convert.ToBoolean(Eval("IsTagged"))%>'></asp:Label>
                                    <asp:Label ID="Label12" Width="50px" runat="server" Text="" Visible='<%# ((!Convert.ToBoolean(Eval("IsTagged")) && !Convert.ToBoolean(Eval("IsVendor"))) == true? true: false)%>'></asp:Label>
                                    <asp:LinkButton Width="54px" ID="uoLnkBtnTag" CommandName="Tag" CssClass="BtnTag"  Visible='<%# ((!Convert.ToBoolean(Eval("IsTagged")) && Convert.ToBoolean(Eval("IsVendor"))) == true? true: false)%>'
                                        OnClientClick='<%# "javascript:return confirmTag("+ Eval("SeafarerIdInt") + ", \"" + Eval("FirstName") + "\");" %>'
                    ...
                    <div align="left">
                        <asp:DataPager ID="uoDataPagerCancelledManifest" runat="server" PagedControlID="uoListViewCancelledManifest"
                            PageSize="20">
                            <Fields>
                                <asp:NumericPagerField ButtonType="link" NumericButtonCssClass="PagerClass" />
                            </Fields>
      ...
      <div id="uoDivConfirmVehicle" >       
       <p style=" text-align:left; padding-left:10px; font-weight:bold;" > Confirmed Vehicle Manifest </p> 
        <table width="100%" cellpadding="0" cellspacing="0" class="LeftClass">
            <tr>
                <td>               
              <%--  OnItemCommand="uoListViewVehicleHeader_ItemCommand"--%>  
                    <div id="DivConfirmVehicleHeader" style="overflow: auto; overflow-x: hidden; width: 100%; overflow-y: hidden;">
                        <asp:ListView runat="server" ID="uoListViewVehicleHeader" 
                        >
                        <LayoutTemplate>
                        </LayoutTemplate>
                        <ItemTemplate>
                            ...
                            <table class="listViewTable">
                                <tr>     
                                    ...
                                    <th style="text-align: center; white-space: normal;display:none;">
                                     ...
                                     <th runat="server" id="TagTH" style="text-align: center; white-space: normal;display:none;">
                                        <asp:Label runat="server" ID="Label7" Text="Tagged" Width="50px" ></asp:Label>
                                    </th> 
                                    <th style="text-align: center; white-space: normal;">
                                        <asp:LinkButton ID="LinkButton5" runat="server" CommandName="RequestStatus"
...
--%>                
                <div id="DivVehicleDetail" style="overflow: auto; width: 100%; overflow-x: scroll; overflow-y: auto;"
                    onscroll="divScrollL();">
                    <asp:ListView runat="server" ID="uolistviewVehicleInfo" 
                        ...
                        <ItemTemplate>
                            ...
                            <tr>   
                                ...
                                <td runat="server" id= "TagTD"  style="white-space: normal; display:none;">
                                    <asp:Label ID="Label26" Width="50px" runat="server" Text="Tagged" Visible='<%# Convert.ToBoolean(Eval("IsTagged"))%>'></asp:Label>
       ...
       <div id="uoDivCancelledVehicle" >    
        <p style=" text-align:left; padding-left:10px; font-weight:bold;" > Cancelled Vehicle Manifest </p>    
        <table width="100%" cellpadding="0" cellspacing="0" class="LeftClass">
            <tr>
                <td>    
              <%--  OnItemCommand="uoListViewVehicleHeader_ItemCommand"--%>             
                    <div id="DivCancelledVehicleHeader" style="overflow: auto; overflow-x: hidden; width: 100%; overflow-y: hidden;">
                        <asp:ListView runat="server" ID="uoListViewCancelledVehicleHeader" 
                        >
                        <LayoutTemplate>
                        </LayoutTemplate>
                        <ItemTemplate>
                            ...
                            <table class="listViewTable">
                                <tr>     
                                    ...
                                    <th style="text-align: center; white-space: normal; display:none;">
                                     ...
                                     <th runat="server" id="TagTH"  style="white-space: normal; display:none;">
                                        <asp:Label runat="server" ID="Label7" Text="Tagged" Width="50px" ></asp:Label>
                                    </th> 
                                    <th style="text-align: center; white-space: normal;">
                                        <asp:LinkButton ID="LinkButton5" runat="server" CommandName="RequestStatus"
                    ...
                    <div id="DivCancelledVehicleDetail" style="overflow: auto; width: 100%; overflow-x: scroll; overflow-y: auto;"
                        onscroll="divScrollL();">
                        <%-- OnDataBound="uolistviewVehicleInfo_DataBound" 
                         onitemcommand="uolistviewVehicleInfo_ItemCommand"
                        --%>                        
                        <asp:ListView runat="server" ID="uoListViewVehicleCancelManifest" >
                        ...
                        <div align="left">
                            <asp:DataPager ID="DataPager1" runat="server" PagedControlID="uolistviewVehicleInfo"
                                PageSize="20">
                                <Fields>
                                    <asp:NumericPagerField ButtonType="link" NumericButtonCssClass="PagerClass" />
                                </Fields>
    ...
    <asp:ObjectDataSource ID="uoObjectDataSourceManifest" runat="server" MaximumRowsParameterName="iMaxRow"
            ...
            StartRowIndexParameterName="iStartRow" TypeName="TRAVELMART.PortAgentConfirmCancelManifest"
    ...
    <asp:HiddenField ID="uoHiddenFieldHotelConfirm" runat="server" />
...
//                ht = ht * 0.50;
            ...
            $("#DivVehicleDetail").height(ht - 520);
            $("#DivConfirmVehicleHeader").width(wd);
            $("#DivVehicleDetail").width(wd);



            $("#DivCancelledVehicleDetail").height(ht - 520);
            $("#DivCancelledVehicleHeader").width(wd);
            $("#DivCancelledVehicleDetail").width(wd);
        ...
        function getRemarks(sTRid, sRecloc) {
            ...
            $.ajax({
                ...
                data: "{'sTRid': '" + sTRid + "', 'sRecloc': '" + sRecloc + "', 'sExpenseType': '1'}",
                dataType: "json",
        ...
        function ControlSettings() {
            ...
            $("a#ctl00_NaviPlaceHolder_linkCancelRCCL").fancybox(
            {
                'centerOnScroll': false,
                'width': '80%',
                'height': '100%',
                ...
                'onClosed': function() {
                    var a = $("#ctl00_NaviPlaceHolder_uoHiddenFieldHotelConfirm").val();
        ...
        function divScrollL() {
            ...
            var Right = document.getElementById('Div2');
            var Left = document.getElementById('Div3');
        ...
        function CheckUncheckConfirmTransport() {
            ...
            var sURL = 'PortAgentHotelEditor.aspx?AddCancel=' + sAddCancel + '&RecLoc=' + sRecordLocID + '&TReqID=' + sTReqID + '&TransID=' + sTransID;

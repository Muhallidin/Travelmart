<%@ Page Language="C#" MasterPageFile="~/Popup.Master"  AutoEventWireup="true" CodeBehind="PortAgentEditor.aspx.cs" Inherits="TRAVELMART.PortAgent.PortAgentEditor" %>
    ...
    <div>
        <table width="100%">
            <tr>
                ...
                <td  colspan="3">
                    <asp:RadioButtonList ID="HotelType" runat="server">
                        <asp:ListItem Text="Primary Hotel" Value="0"/>
                        <asp:ListItem Text="Service Provider" Value="1"/>
                    </asp:RadioButtonList>
                </td>    
            </tr>
            <tr>
                ...
                <td colspan="3">
                 <asp:DropDownList ID="DropDownListSubHotels" runat="server" 

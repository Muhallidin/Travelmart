...
{
    public partial class PortAgentVehicleManifest : System.Web.UI.Page
    {
        ...
        /// -------------------------------------------------------------------
        /// </summary>
        public List<PortAgentVehicleManifestList> GetVehicleConfirmManifestList(int iStatusID, string sType, int iPortAgentID, string sDate, string sUserID,
            string sRole, string sOrderBy, Int16 iLoadType, int iNoOfDay, Int64 iSFID, int iStartRow, int iMaxRow)
        {
            List<PortAgentVehicleManifestList> list = new List<PortAgentVehicleManifestList>();
            
            if(sType == "New") 
            {
                BLL.PortAgentManifestGetConfirmVehicle(iStatusID, iPortAgentID, sDate, sUserID, sRole, sOrderBy, iLoadType, iNoOfDay, iSFID, iStartRow, iMaxRow);
                ...
                string sTransID = "";
                Session["URL"] = null;
                foreach (PortAgentVehicleManifestList item in list)
                {

<%@ Page Title="" Language="C#" MasterPageFile="~/TravelMartMaster2.Master" AutoEventWireup="True" CodeBehind="PortAgentHotelManifest.aspx.cs" 
Inherits="TRAVELMART.PortAgentHotelManifest" %>
        ...
        <tr>
            <td style ="white-space:nowrap; ">
                ...
                <a id="linkCancel" href="PortAgentHotelEditor.aspx" runat="server" >
                   <asp:Button runat="server" ID = "uoButtonCancelVendor" 
                   Text="Cancel" CssClass="SmallButton" Width="100px" OnClientClick="javascript: return false;"/>
                </a>
                ...
                <a id="linkCancelRCCL" class="clsLinkCancelRCCL" href="PortAgentHotelEditor.aspx" runat="server" >
                    <asp:Button runat="server" ID = "uoButtonCancelRCCL" 
                    Text="Cancel" CssClass="SmallButton" Width="100px" OnClientClick="javascript: return false;"/>
                </a>      
...
<%--<link href="../App_Themes/Default/LinkMenuServices.css" rel="stylesheet" type="text/css" />--%>
   <%--<div style="text-align:left">
        <table  >
            <tr>
                <td id="menuDashboardTbl">
                    <ul id="navigation">
                        <li><a href="#TabHotel" class="active">Hotel Service</a></li>
                        <li><a href="#Transportation">Transportation Sevice</a></li>        
                    </ul>
                </td>
            </tr>
        </table>
   ...
   <%--Hotel Service Manifest--%>
    ...
    <asp:ObjectDataSource ID="uoObjectDataSourceManifest" runat="server" MaximumRowsParameterName="iMaxRow"
            ...
            StartRowIndexParameterName="iStartRow" TypeName="TRAVELMART.PortAgentHotelManifest"

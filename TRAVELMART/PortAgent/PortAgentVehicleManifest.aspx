<%@ Page Title="" Language="C#" MasterPageFile="~/TravelMartMaster2.Master" AutoEventWireup="true" CodeBehind="PortAgentVehicleManifest.aspx.cs" 
Inherits="TRAVELMART.PortAgentVehicleManifest" %>
        ...
        <tr >
            ...
            <td >
                <asp:Button runat="server" ID="uoButtonExport" Text="Export" Width="100px" 
                 ...
                 <a id="linkConfirm" href="PortAgentVehicleEditor.aspx" runat="server" >
                 ...
                 <a id="linkCancel" href="PortAgentVehicleEditor.aspx" runat="server" >
                 ...
                 <a id="linkEditAmount" href="PortAgentVehicleEditor.aspx" runat="server" >
                 ...
                 <a id="linkApprove" href="PortAgentVehicleEditor.aspx" runat="server" >
                ...
                <a id="linkCancelRCCL" href="PortAgentVehicleEditor.aspx" runat="server" >
   ...
   <%--Hotel Service Manifest--%>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function CheckUncheckConfirmTransport() {
            ...
            var sURL = 'PortAgentVehicleEditor.aspx?AddCancel=' + sAddCancel + '&RecLoc=' + sRecordLocID + '&TReqID=' + sTReqID + '&TransID=' + sTransID;

<%@ Page Title="" Language="C#" MasterPageFile="~/TravelMartMaster2.Master" AutoEventWireup="true" CodeBehind="PortAgentApproveVehicleRequest.aspx.cs" Inherits="TRAVELMART.PortAgent.PortAgentApproveVehicleRequest" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="NaviPlaceHolder" runat="server">
    <table width="100%" cellpadding="0" cellspacing="0" class="LeftClass">
        <tr style="width:100%; white-space:nowrap;   ">
            ...
            <td>
                <asp:Button runat="server" ID="uoButtonExport" Text="Export Manifest Confirmed List"  
                    CssClass="SmallButton" onclick="uoButtonExport_Click"  style ="" />
            </td>
            <td style="" id="dtNowrap" >
                 ...
                 <a id="linkCancel" href="PortAgentVehicleEditor.aspx" runat="server" style ="display:none;" >
                 ...
                 <input type="button" id = "uoApprove" value="Approve" class="SmallButton" style="width:100px;  " onclick="setAddHotel(this)" />
                
                 
                 <a id="linkApprove" href="PortAgentVehicleEditor2.aspx" runat="server" style="display:none" >
                    <%--<asp:Button runat="server" ID = "uoButtonApprove" Text="Approve" style="display:none"  CssClass="SmallButton" Width="100px" OnClientClick="javascript: return false;"/>--%>
                </a>
             ...
             <td>
                <input type="button" id = "uoButtonCancel" value="Cancel" class="SmallButton" style="width:100px; " onclick="setAddHotel(this)" />
             </td>
            ...
            <td style="display:none;">
                <a id="uoNonTurnPageRoute"   style ="display:none;" />
    ...
    <div id="DivHotelManifest" onscroll="divScrollL();" style="overflow: auto; width: 100%; overflow-x: scroll; overflow-y: auto;">       
        <table width="100%" cellpadding="0" cellspacing="0" class="LeftClass">
            <tr>
                <td>                 
                    <div id="Av" style="overflow: auto; overflow-x: hidden; width: 100%; overflow-y: hidden;">
                        ...
                        <EmptyDataTemplate>
                            <table class="listViewTable" id="tblListViewVehicle">
                                <tr>     
                        ...
                        <ItemTemplate>
                            ...
                            <tr>   
                                <td class="centerAligned" style="white-space: normal;">
                                    ...
                                    <asp:HiddenField runat="server" ID="uoHiddenFieldIsSelected" Value='false'/>
                                    ...
                                    <asp:CheckBox CssClass="Checkbox" ID="uoCheckBoxConfirm" Width="50px" runat="server"  />
    ...
    <div id="DivConfirm" style="overflow: auto; width: 100%; overflow-x: scroll; overflow-y: auto;display:none " onscroll="divScrollL();" > 
        <div id="DivConfirmedLabel" class="PageSubTitle" style="text-decoration: underline;">
            Confirmed Manifest
        </div>      
        <table width="100%" cellpadding="0" cellspacing="0" class="LeftClass">
            <tr>
                <td>                 
                    <asp:ListView runat="server" ID="uoListViewConfirmedHeader" OnItemCommand="uoListViewVehicleHeader_ItemCommand">
                        <LayoutTemplate>
                        </LayoutTemplate>
                        <ItemTemplate>
                        </ItemTemplate>
    ...
    <div id="DivCancelled" style="overflow: auto; width: 100%; overflow-x: scroll; overflow-y: auto; display:none" onscroll="divScrollL();">   
         <div id="DivCancelledLabel" class="PageSubTitle" style="text-decoration: underline;">
            Cancelled Manifest
        </div>       
        <table width="100%" cellpadding="0" cellspacing="0" class="LeftClass">
            <tr>
                <td>                 
                    <asp:ListView runat="server" ID="uoListViewCancelledHeader" OnItemCommand="uoListViewVehicleHeader_ItemCommand">
                        <LayoutTemplate>
                        </LayoutTemplate>
                        <ItemTemplate>
                        </ItemTemplate>
                    ...
                    <div align="left">
                        <asp:DataPager ID="DataPager2" runat="server" PagedControlID="uolistviewVehicleInfo"
                            PageSize="20">
                            <Fields>
                                <asp:NumericPagerField ButtonType="link" NumericButtonCssClass="PagerClass" />
                            </Fields>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function CheckBooking() {
            ...
            $('.Checkbox > input[name*=uoCheckBoxConfirm]').click(function() {
                document.getElementById(this.id.replace('uoCheckBoxConfirm', 'uoHiddenFieldIsSelected')).value = this.checked;
                console.log(document.getElementById(this.id.replace('uoCheckBoxConfirm', 'uoHiddenFieldIsSelected')).value);

            });
            
            
            document.getElementById("dtNowrap").style.whiteSpace = "nowrap" ;
            ...
            if (session == 4) {
                document.getElementById("uoButtonCancel").style.display = 'block';
                document.getElementById("uoApprove").style.display = 'none';
                ...
                document.getElementById("uoButtonCancel").style.display = 'none';
                document.getElementById("uoApprove").style.display = 'block';
        ...
        function SetTMResolution() {
            ...
            $("#DivHotelManifest").width(wd);
            $("#DivHotelManifest").height(ht);

            $("#DivConfirm").width(wd);
            $("#DivConfirm").height(ht);
        ...
        function CheckUncheckConfirmTransport() {
            ...
            $("#uoTableHotel tr").each(function(i, element) {
                ...
                sStatus = $('td:eq(2) span[id*="uoLabelStatus"]', this);
                RecLocID = $('td:eq(0) input[name*="uoHiddenFieldListRecLocID"]', this);
                TravelReqID = $('td:eq(0) input[name*="uoHiddenFieldListTRID"]', this);
                TransID = $('td:eq(0) input[name*="uoHiddenFieldTransID"]', this);
                PortAgentID = $('td:eq(0) input[name*="uoHiddenFieldPortAgentID"]', this);
            ...
            var sURL = 'PortAgentVehicleEditor2.aspx?AddCancel=' + sAddCancel + '&RecLoc=' + sRecordLocID + '&TReqID=' + sTReqID + '&TransID=' + sTransID + '&PortAgentID=' + PortAgentID; 
        ...
        function CheckUncheckCancelTransport() {
            ...
            $("#uoTableHotel tr").each(function(i, element) {
                ...
                var PortAgentID = $('td:eq(0) input[name*="uoHiddenFieldPortAgentID"]', this);
        ...
        function setAddHotel(val) {
            var count = $('tr', '#uoTableHotel').size();
            var chck = $('.Checkbox > input[name*=uoCheckBoxConfirm]').is(":checked");
            ...
            var canAdd = 0;
            var n = 0;
            var E1ID = "ctl00_NaviPlaceHolder_uolistviewVehicleInfo_ctrl0_";



            $('.Checkbox > input[name*=uoCheckBoxConfirm]').each(function() {
                if ($(this)[0].checked == true) {
                    console.log($(this)[0].id);
                    E1ID = $(this)[0].id.replace("uoCheckBoxConfirm", "");
                    console.log(E1ID);
                    mydata[n] = new Array(1);
                    mydata[n][1] = document.getElementById($(this)[0].id.replace("uoCheckBoxConfirm", "") + "uoHiddenFieldListRecLocID").value;
                    mydata[n][2] = document.getElementById($(this)[0].id.replace("uoCheckBoxConfirm", "") + "uoHiddenFieldListTRID").value;
                    mydata[n][3] = document.getElementById($(this)[0].id.replace("uoCheckBoxConfirm", "") + "uoHiddenFieldSeqNo").value;
                    mydata[n][4] = document.getElementById($(this)[0].id.replace("uoCheckBoxConfirm", "") + "uoHiddenFieldTransID").value;
                    n = n + 1;
                }
            }); 
            if (n > 0) {
                ...
                if (val.id == 'uoButtonCancel') {
                    document.getElementById("uoNonTurnPageRoute").href = "../PortAgent/PortAgentVehicleEditor2.aspx?Action=Cancel&AddCancel=Cancel" + "&dt=" + chdate + "&qTravelReqID=" + mydata + "&pID=" + 0 + "&pRow=" + n + "&paID=" + getQuerystringData("PA") + "&st=5";
                    document.getElementById("uoNonTurnPageRoute").click();
                }

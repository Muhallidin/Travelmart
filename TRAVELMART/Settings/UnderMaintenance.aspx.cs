...
namespace TRAVELMART.Settings
{
    public partial class UnderMaintenance : System.Web.UI.Page
    {
        ...
        protected void uoButtonImmigration_Click(object sender, EventArgs e)
        {
        ...
        public void OpenExcelFile(string strFileName, string filePath)
        {
            ...
            ScriptManager.RegisterStartupScript(uoButtonImmigration, this.GetType(), "CloseModal", strScript, true);
        }
        #endregion      
    }
}

<%@ Page Title="" Language="C#" MasterPageFile="~/Popup.Master" AutoEventWireup="true" CodeBehind="HotelRoomOverrideEdit.aspx.cs" Inherits="TRAVELMART.HotelRoomOverrideEdit" %>
...
<table class="TableEditor">
    <tr>
        <th colspan="3">Room Blocks from Contract</th>
    </tr>
     <tr>
...
<table class="TableEditor">        
    <tr>
        <th colspan="3">Additional Room Blocks</th>
    </tr>
     <tr>
        <td class="caption">Room Block(s):</td>
        <td class="value">
    ...
    <asp:HiddenField ID="uoHiddenFieldReservedCount" runat="server" Value="0"/>
</asp:Content>

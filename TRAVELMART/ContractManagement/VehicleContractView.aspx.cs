...
{
    public partial class VehicleContractView : System.Web.UI.Page
    {
        #region Events
        /// <summary>
        ...
        /// </summary>
        private void vendorVehicleGetContractDetail()
        {
            if (GlobalCode.Field2Int(uoHiddenFieldContractId.Value) > 0)
            {
                ContractBLL.GetVendorVehicleContractByContractID(uoHiddenFieldContractId.Value, uoHiddenFieldBranchId.Value, 0);
                ...
                if (list.Count > 0)
                {
                    ...
                    uoTextBoxVehicleName.Text = list[0].VehicleName;

<%@ Page Title="" Language="C#" MasterPageFile="~/TravelMartMaintenanceMaster.Master" AutoEventWireup="true" CodeBehind="PortAgentContractListView.aspx.cs" Inherits="TRAVELMART.ContractManagement.PortAgentContractListView" %>
...
<script type="text/javascript" language="javascript">
     ...
     <table style="width: 100%" cellspacing="0" >  <%--id="uoTableVehicleContractList" runat="server"--%>   
            ...
            <td style="padding-left: 3px; padding-right: 3px;" colspan="2">
                <div>
                    <table style="width: 100%" cellspacing="0" >                        
                        <tr>
                            <td style="text-align: left;" class="PageTitle" colspan="2">
                                <asp:Panel ID="uoPanelVehicleHead" runat="server" Width="364px">
                                    <%--Vehicle Contract List--%>
                                    <asp:Label ID="ucLabelPortAGent" runat="server" Font-Bold="True" Font-Size="12pt" 
                        ...
                        <tr>
                            <td align="left" style="width: 250px; white-space:nowrap">
                            <span>Group By :</span>
        ...
        <tr>
            <td class="Module" align="right">
                <asp:ListView runat="server" ID="uoPortAgetContractList" 
                    onselectedindexchanging="uoPortAgetContractList_SelectedIndexChanging" 
                    onitemcommand="uoPortAgetContractList_ItemCommand" >
                    <LayoutTemplate>
                    ...
                    <%# ContractAddGroup()%>
                        <tr>
                            ...
                            <td >
                               <asp:HyperLink runat="server" id="uoHyperLinkAmendContract" Visible='<%# Convert.ToBoolean(uoHiddenFieldAmendLinkVisible.Value) %>'
                                NavigateUrl='<%# "~/ContractManagement/PortAgentContractAdd.aspx?vmId=" + Eval("BranchID") + "&cID=" + Eval("ContractID") + "&ufn=" + Request.QueryString["ufn"] + "&dt=" + Request.QueryString["dt"] %>'>
                                    Amend Contract</asp:HyperLink>  
                            </td> 
                           <td>
                                <asp:LinkButton ID="uoLinkButtonDelete" runat="server" Visible='<%# Convert.ToBoolean(uoHiddenFieldAmendLinkVisible.Value) %>'
                                    Enabled='<%# !InactiveControl( Eval("IsCurrent")) %>' OnClientClick="return confirmDelete();"
                ...
                <asp:DataPager ID="uoPortAgetContractListPager" runat="server" PagedControlID="uoPortAgetContractList"
                    PageSize="20" OnPreRender="uoPortAgetContractList_PreRender">
                    <Fields>
    ...
    <asp:HiddenField ID="uoHiddenFieldAmendLinkVisible" runat="server" Value="true"/>        
</asp:Content>

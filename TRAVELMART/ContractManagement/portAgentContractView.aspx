<%@ Page Title="" Language="C#" MasterPageFile="~/Popup.Master" AutoEventWireup="true" CodeBehind="portAgentContractView.aspx.cs" Inherits="TRAVELMART.ContractManagement.portAgentContractView" %>
    ...
    <div class="leftAligned">
        ...
        <table width="100%" style="text-align: left">
            ...
            <tr>
                ...
                <td colspan="2">
                    <asp:TextBox ID="uoTextBoxPortAgentName" runat="server" Width="300px" ReadOnly="true" CssClass="ReadOnly"></asp:TextBox>
                </td>
            </tr> 
            <tr>
                <td>
       ...
       <div class="PageTitle">
            <asp:Panel ID="uoPanelTranspoServiceTitle" runat="server">
                Transportation Service
                <asp:Label ID="uoLabelCollapseTranspo" runat="server" Text="" Font-Size="Small" />
            </asp:Panel>
        </div>
        <asp:Panel ID="uoPanelTranspoService" runat="server" CssClass="CollapsiblePanel">
       <table style ="width:100%">
        <tr>
            <td>
                <asp:GridView ID="uoGridViewPortAgent" runat="server" Width="100%" AutoGenerateColumns="False" CssClass="listViewTable" >
                    <Columns>
       ...
       <cc1:collapsiblepanelextender ID="Collapsiblepanelextender1" runat="server" TargetControlID="uoPanelTranspoService"
            ExpandControlID="uoPanelTranspoServiceTitle" CollapseControlID="uoPanelTranspoServiceTitle" TextLabelID="uoLabelCollapseTranspo"
            CollapsedText="(Show List)" ExpandedText="(Hide List)" Collapsed="false" 
            SuppressPostBack="true">
        </cc1:collapsiblepanelextender>
        <br />
        ...
        <div class="PageTitle">
            <asp:Panel ID="uoPanelHotelServiceTitle" runat="server">
                Hotel Service
                <asp:Label ID="uoLabelCollapseHotel" runat="server" Text="" Font-Size="Small" />
            </asp:Panel>
        </div>
        <asp:Panel ID="uoPanelHotelService" runat="server" CssClass="CollapsiblePanel">
        <table style ="width:100%">
            <tr>
            ...
            <td class="contentValueOrig">
                <asp:TextBox ID="uoTextBoxSingleRoomRate" runat="server" Width="180px" onkeypress="return validate(event);" 
            ...
            <td class="contentValueOrig">
                <asp:TextBox ID="uoTextBoxDoubleRoomRate" runat="server" Width="180px" onkeypress="return validate(event);" 
                ReadOnly="true" CssClass="ReadOnly"></asp:TextBox>                
            </td>
        </tr>
        <tr>
            ...
            <td class="contentValueOrig">
                <asp:CheckBox runat="server" ID="uoCheckBoxIsTaxInclusive" Enabled = "false"/>
            </td>
             <td class="contentCaptionOrig">
                Is Rate by Percent:
            </td>
            <td class="contentValueOrig">
                <asp:CheckBox runat="server" ID="uoCheckBoxIsRateByPercent" Enabled="false" />
            </td>
        </tr>
         <tr>
            <td class="contentCaptionOrig">
            ...
            <td class="contentValueOrig">
                <asp:TextBox ID="uoTextBoxTaxHotel" runat="server" Width="180px" onkeypress="return validate(event);"
                ReadOnly="true" CssClass="ReadOnly"></asp:TextBox>&nbsp;%
            </td>
             <td class="contentCaptionOrig">
                Cost Plus:
            ...
            <td class="contentValueOrig">
                <asp:TextBox ID="uoTextBoxCostPlus" runat="server" Width="180px" onkeypress="return validate(event);" 
                ReadOnly="true" CssClass="ReadOnly"></asp:TextBox>&nbsp;%
            </td>
        </tr>
        <tr>
            ...
            <td class="contentValueOrig">
                <asp:TextBox ID="uoTextBoxMealStandard" runat="server" Width="180px" onkeypress="return validate(event);" 
                ReadOnly="true" CssClass="ReadOnly"></asp:TextBox>
            </td>
             <td class="contentCaptionOrig">
                Increased Meal:
            ...
            <td class="contentValueOrig">
                <asp:TextBox ID="uoTextBoxMealIncreased" runat="server" Width="180px" onkeypress="return validate(event);" 
                ReadOnly="true" CssClass="ReadOnly"></asp:TextBox>
            </td>
        </tr>
         <tr>
            ...
            <td class="contentValueOrig">
                <asp:TextBox ID="uoTextBoxSurchargeSingle" runat="server" Width="180px" onkeypress="return validate(event);" 
                ReadOnly="true" CssClass="ReadOnly"></asp:TextBox>
            </td>
             <td class="contentCaptionOrig">
            ...
            <td class="contentValueOrig">
                <asp:TextBox ID="uoTextBoxSurchargeDouble" runat="server" Width="180px" onkeypress="return validate(event);" 
                ReadOnly="true" CssClass="ReadOnly"></asp:TextBox>
            </td>
        </tr>
        </table>
        </asp:Panel>
        <cc1:collapsiblepanelextender ID="Collapsiblepanelextender2" runat="server" TargetControlID="uoPanelHotelService"
            ExpandControlID="uoPanelHotelServiceTitle" CollapseControlID="uoPanelHotelServiceTitle" TextLabelID="uoLabelCollapseHotel"
            CollapsedText="(Show List)" ExpandedText="(Hide List)" Collapsed="false" 
            SuppressPostBack="true">
        </cc1:collapsiblepanelextender>
    </div>   

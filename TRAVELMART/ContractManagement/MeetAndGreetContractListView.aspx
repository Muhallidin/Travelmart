<%@ Page Language="C#" MasterPageFile="~/TravelMartMaintenanceMaster.Master" AutoEventWireup="true" CodeBehind="MeetAndGreetContractListView.aspx.cs" Inherits="TRAVELMART.ContractManagement.MeetAndGreetContractListView" %>
...
<script type="text/javascript" language="javascript">
    function OpenContract(branchID, contractID) {
        var URLString = "../ContractManagement/MeetAndGreetContractView.aspx?";
                ...
                <asp:ListView runat="server" ID="uoVehicleContractList" 
                    ...
                    <%# ContractAddGroup()%>
                        <tr>
                            ...
                            <td >
                               <asp:HyperLink runat="server" id="uoHyperLinkAmendContract" NavigateUrl='<%# "~/ContractManagement/MeetAndGreetContractAdd.aspx?vmId=" + Eval("BranchID") + "&cID=" + Eval("ContractID") + "&ufn=" + Request.QueryString["ufn"] + "&dt=" + Request.QueryString["dt"] %>'>

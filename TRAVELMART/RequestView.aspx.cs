...
namespace TRAVELMART
{
    public partial class RequestView : System.Web.UI.Page
    {
        ...
        /// MOdified by:    Charlene Remotigue
        /// (description)   intitialize session values, 
        ///                 move other initialization to intializevalues function
        ///                 Do not get user date range
        ///                 
        /// </summary>
...
//                if (uoButtonViewAll.Visible == true)
        ...
        /// (description) intialize session values
        /// </summary>
        protected void InitializeValues()
        {
            ...
            Session["DateTo"] = GlobalCode.Field2DateTime(Session["DateFrom"]).ToShortDateString();

            bool HideVessel = HideVesselHeader();
            if (HideVessel)
            {
        ...
        {            
            ...
            try
            {
                ...
                vesselList = VesselBLL.GetVesselList(uoHiddenFieldUser.Value, uoHiddenFieldDate.Value, sDateTo, GlobalCode.Field2String(Session["Region"]), GlobalCode.Field2String(Session["Country"]),
        ...
        protected bool HideVesselHeader()
        {
            if (uoDropDownListGroupBy.SelectedValue == "VesselName")
            {
                return false;
        ...
        /// Author: Charlene Remotigue
        /// Date Created: 16/04/2012
        /// Description: hide hotel header
        /// </summary>
        /// <returns></returns>
        protected bool HideHotelHeader()
        {
            if (uoDropDownListGroupBy.SelectedValue == "HotelName")
            {
                return false;
        ...
        private void ClearFilter()
        {
            ...
            uoDropDownListGroupBy.SelectedIndex = 0;

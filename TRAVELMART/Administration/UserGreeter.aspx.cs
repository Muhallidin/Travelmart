    ...
    {
        public partial class UserGreeter : System.Web.UI.Page
        {
            #region "Events"
            ...
            private void AddVehicleVendor()
            {
                ...
                using (DataTable dtVendor = new DataTable())
                {
                    ...
                    if (dtVendor.Rows.Count > 0)
                    {
                        ...
                        UserVendorBLL.GreeterVendorAddEdit(uoHiddenFieldUser.Value, true, dtVendor,
                            "Vehicle", "Add Greeter Vehicle Vendor assignment", "AddVehicleVendor",
            ...
            private void RemoveVehicleVendor()
            {
                ...
                using (DataTable dtVendor = new DataTable())
                {
                    ...
                    if (dtVendor.Rows.Count > 0)
                    {
                        ...
                        UserVendorBLL.GreeterVendorAddEdit(uoHiddenFieldUser.Value, false, dtVendor,
                            "Vehicle", "Remove Greeter Vehicle Vendor assignment", "RemoveVehicleVendor",
                            Path.GetFileName(Request.Path), CommonFunctions.GetDateTimeGMT(currentDate),
                            uoHiddenFieldUserName.Value);
                    }
                }
        ...
        /// =============================================================     
        /// </summary>
            public List<VehicleVendorDTO> GetGreeterVendorList(string sLoginUser, string sUserID, string sVendorToFind, bool bIsToBeAdded, string sVendorType,
               int iStartRow, int iMaxRow, Int16 iLoadType, string sOrderBy, string sToLoad)
            {
                ...
                {
                    UserVendorBLL.GreeterVendorGet(sLoginUser, sUserID, sToFind, bIsToBeAdded, sVendorType,
            ...
            /// =============================================================     
            /// </summary>
            public List<VehicleVendorDTO> GetGreeterVehicleVendorAddedList(string sLoginUser, string sUserID, string sVendorToFind, bool bIsToBeAdded, string sVendorType,
               int iStartRow, int iMaxRow, Int16 iLoadType, string sOrderBy, string sToLoad)
            {
            ...
            /// Author:         Josephine Monteza
            /// Date Created:   07/Oct/2017
            /// Descrption:     Get Vendor Count of Greeter
            /// =============================================================
            /// </summary>
            ...
            /// <returns></returns>
            public int GetGreeterVendorCount(string sLoginUser, string sUserID, string sVendorToFind, bool bIsToBeAdded, string sVendorType,

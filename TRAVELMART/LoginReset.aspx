<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginReset.aspx.cs" Inherits="TRAVELMART.LoginReset" %>
                    ...
                    <div style="text-align: center; margin: auto; width: 400PX">
                        ...
                        <asp:ChangePassword ID="ChangePassword1" BackColor="White" Width="400px" runat="server"
                            ...
                            <ChangePasswordTemplate>
                                <asp:Label ID="FailureText" runat="server" EnableViewState="False" Style="color: Red;"></asp:Label>
                                                ...
                                                <table border="0" cellpadding="0">
                                                    ...
                                                    <tr>
                                                        <td colspan="2" class="ErrorMessage">
                                                            * Note: Password must be at least 8 characters long and a combination of 

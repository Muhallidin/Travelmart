<%@ Page Title="" Language="C#" MasterPageFile="~/TravelmartMasterPage.Master" AutoEventWireup="true" CodeBehind="CrewAssistNew.aspx.cs" Inherits="TRAVELMART.CrewAssistNew" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="NaviPlaceHolder" runat="server" >
                        ...
                        <table id="TableRemark" style="width:100%; height:100%; vertical-align:top; border-style:solid; border-width:thin; background-color:#FFFFFF;" >
                           ...
                           <tr>
                               ...
                               <td style="padding-left:3px; vertical-align:top;">
                                   <asp:Button ID="btnSaveRemark" runat="server" Text="Save" />
                               </td>
                           </tr>
                        </table>
                    </td>
                        ...
                        <div>
                            ...
                            <table style=" width:100%;">
                                <tr>
                                    ...
                                    <td  style="white-space:nowrap;  " >
                                        <asp:CheckBox ID="uoCheckBoxShow" Text= "Show Past date"  runat="server" AutoPostBack="true"/>
                                         &nbsp;
                                         &nbsp;
                        ...
                        <div id="divHotelBooking">
                              ...
                              <table style=" width:100%;">
                                <tr>
                                    ...
                                    <td >
                                         <asp:Button runat="server" ID="uoButtonAddHotel"  CssClass="SmallButton" Text="Add Hotel"
                                                />
                                    </td>
                                </tr>
                            </table>
                                      ...
                                      <td >
                                        ...
                                        <td style="white-space:nowrap; vertical-align:middle; padding-top:3px; border-right-width:thin; text-align:center; margin:-0px; width:-1px;">
                                         ...
                                         --%>
                                           ...
                                           <asp:HiddenField runat="server" ID="hoContractRate" Value='<%# Eval("ContractedRateMoney") %>' />
                                           <asp:HiddenField runat="server" ID="hoConfirmRate" Value='<%# Eval("ConfirmRateMoney") %>' />
                                           <asp:HiddenField runat="server" ID="uoMealVoucher" Value='<%# Eval("MealVoucherMoney") %>' />

                                           <asp:HiddenField runat="server" ID="hoIsBreakfast" Value='<%# Eval("MealBreakfastBit") %>' />
                                           <asp:HiddenField runat="server" ID="hoIsLunch" Value='<%# Eval("MealLunchBit") %>' />
                                           <asp:HiddenField runat="server" ID="hoIsDinner" Value='<%# Eval("MealDinnerBit") %>' />
                                           <asp:HiddenField runat="server" ID="hoIsAddMeal" Value='<%# Eval("MealLunchDinnerBit") %>' />
                                           <asp:HiddenField runat="server" ID="hoIsWithShuttle" Value='<%# Eval("WithShuttleBit") %>' />
                                          
                                          
                                           <asp:HiddenField runat="server" ID="hoEmail" Value='<%# Eval("HotelEmail") %>' />
                                           <asp:HiddenField runat="server" ID="hoComment" Value='<%# Eval("HotelComment") %>' />
                    ...
                    <td style="width:100% ; vertical-align:top;   " >
                         <table style=" padding-top:-10px; width: 100%; margin-top:-5px; vertical-align:text-top;  " border="0">
                            <tr >
                                ...
                                <td  style=" width:25%;">
                                    <a href="#PortAgent"  id="navPortAgent" class="nav">Service Provider</a>
                                </td>
                                 <td  style=" width:25%;">
                                    <a href="#MeetandGreet" id="navMeetAndGreet" class="nav">Meet and Greet</a>
                                </td>
                                    ...
                                    <div id="TabHotel" class="TabClass">
                                        <table style="border: 1px;" id="TabHotelTable" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td class="value">
                                                    <asp:DropDownList ID="uoDropDownListRoomeType" runat="server" CssClass="TextBoxInput" onchange="SaveHotel()"
                                                        Width="85px">
                            ...
                            <tr>
                                <td style="white-space:nowrap;" colspan="4" >
                                    ...
                                    <asp:Button runat="server" ID="uoButtonFinish" CssClass="SmallButton" Text="Finish"
                                        OnClientClick="return ProcessCrewAssistRequest();"/>
                                         &nbsp;
    ...
    <script type="text/javascript" language="javascript">
        ...
        function ShowRemarkLis() {
            ...
            $(".ResourceOption").click(function() {
                if ($('div[class=DivCrewAssistComment]').attr('id') == 'ctl00_NaviPlaceHolder_txtRemark') {
                    //document.getElementById('ctl00_NaviPlaceHolder_txtRemark').focus();
        ...
        function clickConfirm() {
            ...
            var r = confirm('Do you want to proceed the reques CM?');
            if (r != true) {
                return false;
            }
            return true;
        ...
        function navigate() {
            ...
            $("[name*=uoCheckBoxsHotelTransaction]").click(function() {
                ...
                if (myCheck == true) {
                    ...
                    document.getElementById("<%= uoTextBoxCheckinDate.ClientID %>").value = GetDate(document.getElementById("ctl00_NaviPlaceHolder_uoListViewHotelBook_ctrl" + rowNum + "_lblCheckOutDate").innerHTML);
            ...
            if ($("[id$=uoHiddenFieldExpendType]").val() == '0') {
                ...
                if (hotelName.substring(0, 2) == 'HT') {
                    ...
                    if (val == true) {
                        ...
                        document.getElementById('ctl00_NaviPlaceHolder_btnPrimaryHotel').click();
